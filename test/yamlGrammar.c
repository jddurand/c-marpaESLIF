...
const static char *yamls = "\n"
  ...
  "                               else\n"
  "                                 return [[\n"
  "                                          ( <s space> <s indent less than>-->(n-1) | /* Nothing */ )\n"
  "                                        ]]\n"
  "                               end\n"
  "                             end -->(n)\n"
  ...
  "                               else\n"
  "                                 return [[\n"
  "                                          ( <s space> <s indent less or equal>-->(n-1) | /* Nothing */ )\n"
  "                                        ]]\n"
  "                               end\n"
  "                             end -->(n)\n"
  ...
  "                     ::luac->function(n)\n"
  "                               print('<s block line prefix><--('..tostring(n)..' [type: '..type(n)..'])')\n"
  "                               return [[\n"
  "                                        <s indent>-->(n)\n"
  "                                      ]]\n"
  "\n"
  ...
  "                     ::luac->function(n)\n"
  "                               print('<s flow line prefix><--('..tostring(n)..' [type: '..type(n)..'])')\n"
  "                               return [[\n"
  "                                        ( <s indent>-->(n) <s separate in line> | <s indent>-->(n) )\n"
  "                                      ]]\n"
  "                             end -->(n)\n"
  "\n"
  "/* [70] */ <l empty><--(n,c) ::= . =>\n"
  "                     ::luac->function(n,c)\n"
  "                               print('<l empty><--('..tostring(n)..' [type: '..type(n)..'], '..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               return [[\n"
  "                                        ( ( <s line prefix>-->(n,c) | <s indent less than>-->(n) ) <b as line feed> )\n"
  "                                      ]]\n"
  "                             end -->(n)\n"
  "/* [71] */ <b l trimmed><--(n,c) ::= . =>\n"
  "                     ::luac->function(n,c)\n"
  "                               print('<b l trimmed><--('..tostring(n)..' [type: '..type(n)..'], '..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               return [[\n"
  "                                        <b non content> <l empty many>-->(n,c)\n"
  "                                      ]]\n"
  "                             end -->(n)\n"
  "/* [72] */ <b as space> ::= <b break>\n"
  "/* [73] */ <b l folded><--(n,c) ::= . =>\n"
  "                     ::luac->function(n,c)\n"
  "                               print('<b l folded><--('..tostring(n)..' [type: '..type(n)..'], '..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               return [[\n"
  ...
  "/* [74] */ <s flow folded><--(n) ::= . =>\n"
  "                     ::luac->function(n)\n"
  "                               print('<s flow folded><--('..tostring(n)..' [type: '..type(n)..'])')\n"
  "                               return [[\n"
  ...
  "                                      ]]\n"
  "                             end -->(n)\n"
  "/* [75] */ <c nb comment text> ::= <c comment> /* '#' */ <nb char any>\n"
  ...
  "\n"
  "/* [79] */ <s l comments> ::= ( <s b comment> | <start of line> ) <l comment any>\n"
  "\n"
  "/* [80] */ <s separate><--(n,c) ::= . =>\n"
  "                     ::luac->function(n,c)\n"
  ...
  "                     ::luac->function(n)\n"
  "                               print('<s separate lines><--('..tostring(n)..' [type: '..type(n)..'])')\n"
  "                               return [[\n"
  ...
  "/* [87] */ <ns yaml version> ::= <ns dec digit many> '.' <ns dec digit many>\n"
  ...
  "/* [92] */ <c named tag handle> ::= <c tag> /* '!' */ <ns word char many> <c tag> /* '!' */\n"
  "/* [93] */ <ns tag prefix> ::= <c ns local tag prefix>\n"
  "                             | <ns global tag prefix>\n"
  "/* [94] */ <c ns local tag prefix> ::= <c tag> /*'!' */ <ns uri char any>\n"
  "/* [95] */ <ns global tag prefix> ::= <ns tag char> <ns uri char any>\n"
  "/* [96] */ <c ns properties><--(n,c) ::= . =>\n"
  "                     ::luac->function(n,c)\n"
  "                               print('<c ns properties><--('..tostring(n)..' [type: '..type(n)..'], '..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               return [[\n"
  "                                        ( <c ns tag property>\n"
  ...
  "                                 | <c ns shorthand tag>\n"
  "                                 | <c non specific tag>\n"
  "/* [98] */ <c verbatim tag> ::= \"!<\" <ns uri char many> '>'\n"
  "/* [99] */ <c ns shorthand tag> ::= <c tag handle> <ns tag char many>\n"
  ...
  "  | [\\x{E000}-\\x{FEFE}\\x{FF00}-\\x{FFFD}]:u     # Additional Unicode Areas minus 0xFEFF\n"
  "  | [\\x{010000}-\\x{10FFFF}]:u # 32 bit\n"
  "/* [103] */ <ns anchor name> ::= <ns anchor char many>\n"
  ...
  "/* [135] */ <ns plain multi line><--(n,c) ::= <ns plain one line>-->(c) <s ns plain next line any>-->(n,c)\n"
  "/* [136] */\n"
  "<in flow><--(n,c) ::= . => \n"
  "                     ::luac->function(n,c)\n"
  ...
  "                               end\n"
  "                             end -->(n,t)\n"
  "/* [167] */ <l strip empty><--(n) ::= <l strip empty unit any>-->(n) <l trail comments maybe>-->(n)\n"
  "/* [168] */ <l keep empty><--(n) ::= <l keep empty unit any>-->(n) <l trail comments maybe>-->(n)\n"
  ...
  "  <l empty any>-->(n,'BLOCK-IN')\n"
  "  <s indent>-->(n) <nb char many>\n"
  "/* [172] */ <b nb literal next><--(n) ::=\n"
  "  <b as line feed>\n"
  "  <l nb literal text>-->(n)\n"
  "/* [173] */ <l literal content><--(n,t) ::= <l nb literal text>-->(n) <b nb literal next any>-->(n) <b chomped last>-->(t) <l chomped empty>-->(n,t)\n"
  "                                          |                                                                                <l chomped empty>-->(n,t)\n"
  "/* [174] */ <c l folded><--(n) ::=\n"
  "  <c folded>                 # '>'\n"
  "  <c b block header>-->(t)\n"
  ...
  "  <ns l compact sequence unit any>-->(n)\n"
  ...
  "  <ns l compact mapping unit any>-->(n)\n"
  ...
  "                               end\n"
  "                             end -->(n,c)\n"
  "/* [202] */ <l document prefix> ::= <c byte order mark> <l comment any>\n"
  "                                  |                     <l comment any>\n"
  ...
  "#\n"
  "\n"
  "/* [211] */ <l yaml stream> ::= <l document prefix not nullable any> <l any document maybe> <l yaml stream unit any>\n"
  "                              |                                      <l any document maybe> <l yaml stream unit any>\n"
  "\n"
  "<l document prefix not nullable> ::= <c byte order mark> <l comment many>\n"
  "                                  |                      <l comment many>\n"
  "<l yaml stream unit> ::= <l document suffix many> <l document prefix not nullable any> <l any document maybe>\n"
  "                       | <l document suffix many>                                      <l any document maybe>\n"
  "                       | <c byte order mark>\n"
  "                       | <l comment>\n"
  "                       | <l explicit document>\n"
  "<l yaml stream unit any> ::= <l yaml stream unit>*\n"
  "\n"
  "#\n"
  "# Helpers\n"
  "# -------\n"
  ...
  "<nb char any> ::= <nb char>*\n"
  "<nb char many> ::= <nb char>+\n"
  "<l comment any> ::= <l comment>*\n"
  "<l comment many> ::= <l comment>+\n"
  "<ns directive name unit> ::= <s separate in line> <ns directive parameter>\n"
  "<ns dec digit many> ::= <ns dec digit>+\n"
  "<ns word char many> ::= <ns word char>+\n"
  "<ns uri char any> ::= <ns uri char>*\n"
  "<ns uri char many> ::= <ns uri char>+\n"
  "<ns tag char many> ::= <ns tag char>+\n"
  "<ns anchor char many> ::= <ns anchor char>+\n"
  "<s white any> ::= <s white>*\n"
  "<l empty n FLOW_IN any><--(n) ::= <l empty>-->(n,'FLOW-IN')*\n"
  "<nb ns double in line unit> ::= <s white any> <ns double char>\n"
  "<nb ns single in line unit> ::= <s white any> <ns single char>\n"
  "<ns plain safe minus c mapping value and c comment><--(c) ::= . => \n"
  "                     ::luac->function(c)\n"
  ...
  "    <s white any>\n"
  "    <ns plain char>-->(c)\n"
  "<s ns plain next line any><--(n,c) ::= <s ns plain next line>-->(n,c)*\n"
  ...
  "<l strip empty unit any><--(n) ::= <l strip empty unit>-->(n)*\n"
  "<l keep empty unit><--(n) ::= <l empty>-->(n,'BLOCK-IN')\n"
  "<l keep empty unit any><--(n) ::= <l keep empty unit>-->(n)*\n"
  "<l nb folded lines unit><--(n) ::= <b l folded>-->(n,'BLOCK-IN') <s nb folded text>-->(n)\n"
  "<l nb folded lines unit any><--(n) ::= <l nb folded lines unit>-->(n)*\n"
  "<l empty any><--(n,c) ::= <l empty>-->(n,c)*\n"
  "<b nb literal next any><--(n) ::= <b nb literal next>-->(n)*\n"
  "<l nb spaced lines unit><--(n) ::= <b l spaced>-->(n) <s nb spaced text>-->(n)\n"
  "<l nb spaced lines unit any><--(n) ::= <l nb spaced lines unit>-->(n)*\n"
  "<l nb diff lines unit><--(n) ::= <b as line feed> <l nb same lines>-->(n)\n"
  "<l nb diff lines unit any><--(n) ::= <l nb diff lines unit>-->(n)*\n"
  ...
  "<ns l compact sequence unit any><--(n) ::= <ns l compact sequence unit>-->(n)*\n"
  ...
  "<ns l compact mapping unit any><--(n) ::= <ns l compact mapping unit>-->(n)*\n"
  "<l directive many> ::= <l directive>+\n"
  "<l any document maybe> ::= <l any document>\n"
  "<l any document maybe> ::=\n"
  "# <l document prefix any> ::= <l document prefix>*\n"
  "<l document suffix many> ::= <l document suffix>+\n"
  "<l document prefix not nullable any> ::= <l document prefix not nullable>*\n"
  "<l empty many><--(n,c) ::= <l empty>-->(n,c)+\n"
  "\n"
  "<luascript>\n"
