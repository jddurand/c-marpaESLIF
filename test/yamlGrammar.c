...
const static char *yamls = "\n"
  ...
  "                                                                    tojoin[#tojoin + 1] = m['event']\n"
  "                                                                  end\n"
  "                                                                  print('Input['..marpaESLIFRecognizer:line()..','..marpaESLIFRecognizer:column()..']: <'..(tostring(marpaESLIFRecognizer:input(1,10)) or '          ')..'> Events: '..table.concat(tojoin, ' '))\n"
