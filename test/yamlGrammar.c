...
const static char *yamls = "\n"
  ...
  "                     ::luac->function(n)\n"
  "                               return [[\n"
  "                                        ( <b non content> <l empty>-->(n,c) | <b l trimmed> <l empty>-->(n,c) )\n"
  "                                      ]]\n"
  "                             end -->(n)\n"
  ...
  "/* [127] */ <ns plain safe><--(c) ::= . => \n"
  "                     ::luac->function(c)\n"
  "                               print('<nb plain safe><--('..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               if (c == 'FLOW-OUT') then\n"
  "                                 return [[\n"
  "                                          <ns plain safe out>\n"
  "                                        ]]\n"
  ...
  "<ns plain><--(n,c) ::= . => \n"
  "                     ::luac->function(c)\n"
  "                               print('<nb plain><--('..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               if (c == 'FLOW-OUT') then\n"
  "                                 return [[\n"
  ...
  "<in flow><--(n,c) ::= . => \n"
  "                     ::luac->function(c)\n"
  "                               print('<in flow><--('..tostring(c)..' [type: '..type(c)..'])')\n"
  "                               if (c == 'FLOW-OUT') then\n"
  "                                 return [[\n"
