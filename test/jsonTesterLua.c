...
const static char *dsl = "\n"
  ...
  "\n"
  "event :discard[switch]  = nulled discardOn                                                # Implementation of discard disabing using reserved ':discard[on]' keyword\n"
  "event :discard[switch] = nulled discardOff                                               # Implementation of discard enabling using reserved ':discard[off]' keyword\n"
  "\n"
