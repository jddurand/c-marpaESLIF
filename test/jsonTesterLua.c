...
const static char *dsl = "\n"
  ...
  "<luascript>\n"
  "  valueContext = {}\n"
  "  function symbol_action(x, y)\n"
  "    return 'x'\n"
  "  end\n"
  "  function do_array(x, y)\n"
  "    return x\n"
  "  end\n"
  "  function do_empty_array(x, y)\n"
  "    valueContext[#valueContext+1]={}\n"
  "    return #valueContext\n"
  "  end\n"
  "  function do_true(x, y)\n"
  "    return true\n"
  "  end\n"
  "  function do_false(x, y)\n"
  "    return false\n"
  "  end\n"
  "  function do_number(number_as_string)\n"
  "    error('=>'..tostring(number_as_string))\n"
  "    local value = number(number_as_string)\n"
  "    abort('=>'..value)\n"
  "    return value\n"
  "  end\n"
  "</luascript>\n"
