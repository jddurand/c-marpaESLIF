...
const static char *dsl = "\n"
  ":default ::= action => ::shift symbol-action => ::lua->lua_do_symbol\n"
  ":start       ::= json\n"
  "json         ::= object\n"
  "               | array\n"
  ...
  "members      ::= pair*                 action => ::lua->lua_do_array separator => ','\n"
  "pair         ::= string ':' value      action => ::lua->lua_do_array\n"
  "value        ::= string\n"
  "               | object\n"
  "               | number                action => ::lua->lua_do_number\n"
  "               | array\n"
  "               | 'true'                action => ::lua->lua_do_true\n"
  "               | 'false'               action => ::lua->lua_do_false\n"
  "               | 'null'                action => ::undef\n"
  "array        ::= '[' ']'               action => ::lua->lua_do_empty_array\n"
  "               | '[' elements ']'\n"
  "# comma is provided as a char class here, to ensure that char classes\n"
  "# as separators are in the test suite.\n"
  "elements     ::= value+                action => ::lua->lua_do_array separator => ','\n"
  "number         ~ int\n"
  "               | int frac\n"
  "               | int exp\n"
  "               | int frac exp\n"
  ...
  "               | 'E+'\n"
  "               | 'E-'\n"
  "string       ::= lstring action => ::lua->lua_do_lstring\n"
  ...
  "  print('marpaESLIFGrammar global variable is: '..tostring(marpaESLIFGrammar))\n"
  "  print('marpaESLIFRecognizer global variable is: '..tostring(marpaESLIFRecognizer))\n"
  "  function lua_do_symbol(context, x)\n"
  "    return 'x'\n"
  "  end\n"
  "  function lua_do_array(context, x, y)\n"
  "    return x\n"
  "  end\n"
  "  function lua_do_empty_array(context)\n"
  "    return {}\n"
  "  end\n"
  "  function lua_do_true(context, x, y)\n"
  "    return true\n"
  "  end\n"
  "  function lua_do_false(context, x, y)\n"
  "    return false\n"
  "  end\n"
  "  function lua_do_number(context, number_as_string)\n"
