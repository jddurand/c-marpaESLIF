...
static short default_meta_action(void *userDatavp, marpaESLIFValue_t *marpaESLIFValuep, int arg0i, int argni, int resulti);
...
const static char *metags = "<null statement>::=';'"
;
