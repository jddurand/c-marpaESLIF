...
const static char *selfs = "# Self grammar\n"
  ...
  "                               else\n"
  "                                 print('regex-action: marpaESLIFRecognizer:input(0, 10) is: <cuthere>'..marpaESLIFRecognizer:input(0, 10)..'</cuthere>')\n"
  "                               end\n"
  "                               return 0\n"
  "                             end\n"
  ...
  "                               else\n"
  "                                 print('event-action: marpaESLIFRecognizer:input(0, 10) is: <cuthere>'..marpaESLIFRecognizer:input(0, 10)..'</cuthere>')\n"
  "                               end\n"
  "                               return true\n"
  "                             end\n"
