...
const static char *selfs = "# Self grammar\n"
  ...
  ":discard                       ::= <whitespace>@'L0'\n"
  ":discard                       ::= <perl comment>@\"L0\"\n"
  ":discard                       ::= <cplusplus comment>@\xE2\x80\x9CL0\xE2\x80\x9D\n"
  "\n"
  "/*\n"
  " * ***************\n"
  " * Event settings:\n"
  ...
  "param_lhs_0_parameter\xEF\xBC\x88 \xEF\xBC\x89       ::= 'Y'\n"
  "param_lhs_1_parameter          <( x )>               ::= 'X'\n"
  "param_lhs_1_parameter\xEF\xBC\x88 x \xEF\xBC\x89     ::= 'Y'\n"
  "param_lhs_2_parameters          <( x, y )>           ::= 'X'\n"
  "param_lhs_2_parameters\xEF\xBC\x88 x, y \xEF\xBC\x89 ::= 'Y'\n"
  "param_rhs_0_parameter                                ::= param_lhs_0_parameter<( )>\n"
  "param_rhs_0_parameter                                ::= param_lhs_0_parameter\xEF\xBC\x88 \xEF\xBC\x89\n"
  "param_lhs_rhs_1_parameter          <( x )>           ::= param_lhs_1_parameter<( $x )>\n"
  "param_lhs_rhs_1_parameter\xEF\xBC\x88 x \xEF\xBC\x89 ::= param_lhs_1_parameter\xEF\xBC\x88 $x \xEF\xBC\x89\n"
  "param_rhs_2_parameters                               ::= param_lhs_2_parameters<( x, y )>\n"
  "param_rhs_2_parameters                               ::= param_lhs_2_parameters\xEF\xBC\x88 x, y \xEF\xBC\x89\n"
