...
const static char *selfs = "\n"
  ...
  "  <adverb item>                  ::= <action> action => ::lua->lua_adverb_item_action_action\n"
  "                                   | <left association>\n"
  "                                   | <right association>\n"
  "                                   | <group association>\n"
  ...
  "  <action>                       ::= 'action' '=>' <action name>  action => ::lua->lua_action_action\n"
  ...
  "  # <lua action name> ::= <lua action name>@+1\n"
  ...
  " <SCRIPT ACTION>                 ::= 'script' action => ::lua->lua_action_name\n"
  "<luascript>\n"
  "  function add ( x, y )\n"
  "    return x + y\n"
  "  end\n"
  ...
  "    return x + y\n"
  "  end\n"
  "  function lua_action_action(context, action_literal, then_literal, action_name)\n"
  "   print('[LUA] lua_action_action')\n"
  "   print('[LUA]   context        is '..tostring(context))\n"
  "   print('[LUA]   action_literal is '..tostring('\"'..action_literal..'\"'))\n"
  "   print('[LUA]   then_literal   is '..tostring('\"'..then_literal..'\"'))\n"
  "   print('[LUA]   action_name    is '..tostring('\"'..action_name..'\"'))\n"
  "   return action_name\n"
  "  end\n"
  "  function lua_adverb_item_action_action(context, action)\n"
  "   print('[LUA] lua_adverb_item_action_action')\n"
  "   print('[LUA]   context is '..tostring(context))\n"
  "   print('[LUA]   action  is '..tostring('\"'..action..'\"'))\n"
  "  end\n"
  "</luascript>\n"
  "\n";
