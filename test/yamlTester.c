...
const static char *yamls = "\n"
  ...
  "\n"
  "<luascript>\n"
  "function c_to_lexeme(what, lexeme)\n"
  ...
  "globalRegexSymbols = {}\n"
  "\n"
  "function s_indent_n_to_lexeme(lexeme)\n"
  "  local context = marpaESLIFContextStackp:get()\n"
  "  local n = context['n']\n"
  "  if (n > 0) then\n"
  ...
  "end\n"
  "\n"
  "function s_indent_lt_n_to_lexeme(lexeme)\n"
  "  local context = marpaESLIFContextStackp:get()\n"
  "  local n = context['n']\n"
  "  if (n > 1) then\n"
  ...
  "end\n"
  "\n"
  "function s_indent_le_n_to_lexeme(lexeme)\n"
  "  local context = marpaESLIFContextStackp:get()\n"
  "  local n = context['n']\n"
  "  if (n >= 1) then\n"
  ...
  "end\n"
  "\n"
  "function yamlEventAction(eventName)\n"
  "  if     (eventName == '^s_indent_n')     then return s_indent_n_to_lexeme('S_INDENT_N')\n"
  "  elseif (eventName == '^s_indent_lt_n')  then return s_indent_lt_n_to_lexeme('S_INDENT_LT_N')\n"
  "  elseif (eventName == '^s_indent_le_n')  then return s_indent_le_n_to_lexeme('S_INDENT_LE_N')\n"
  "  elseif (eventName == 'ns_s_implicit_yaml_key$') then\n"
  "  elseif (eventName == 'c_s_implicit_json_key$') then\n"
  "  elseif (eventName == '^ns_plain_safe_c_lookup') then\n"
  "  elseif (eventName == '^ns_plain_safe_c_negative_lookup') then\n"
  "  elseif (eventName == '^ns_char_negative_lookup') then\n"
  "  elseif (eventName == '^c_forbidden_negative_lookup') then\n"
  "  elseif (eventName == '^c_is_block_out') then return c_to_lexeme('block-out', 'C IS BLOCK OUT')\n"
  "  elseif (eventName == '^c_is_block_in')  then return c_to_lexeme('block-in',  'C IS BLOCK IN')\n"
  "  elseif (eventName == '^c_is_flow_out')  then return c_to_lexeme('flow-out',  'C IS FLOW OUT')\n"
  "  elseif (eventName == '^c_is_flow_in')   then return c_to_lexeme('flow-in',   'C IS FLOW IN')\n"
  "  elseif (eventName == '^c_is_block_key') then return c_to_lexeme('flow-in',   'C IS BLOCK KEY')\n"
  "  elseif (eventName == '^c_is_flow_key')  then return c_to_lexeme('flow-key',  'C IS FLOW KEY')\n"
  "  else\n"
  "    error('Invalid event name: '..tostring(eventName))\n"
  "  end\n"
  "end\n"
  "</luascript>\n"
  ;
