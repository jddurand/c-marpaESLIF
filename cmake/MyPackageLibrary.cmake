MACRO (MYPACKAGELIBRARY config_in config_out)
  ...
  FOREACH (_target ${PROJECT_NAME} ${PROJECT_NAME}_static)
    TARGET_COMPILE_DEFINITIONS(${_target}
      PRIVATE -D${_PROJECTNAME}_VERSION_MAJOR=${versionMajor}
      PRIVATE -D${_PROJECTNAME}_VERSION_MINOR=${versionMinor}
      PRIVATE -D${_PROJECTNAME}_VERSION_PATCH=${versionPatch}
      PRIVATE -D${_PROJECTNAME}_VERSION="${${_PROJECTNAME}_VERSION}"
      )
  ENDFOREACH ()
  #
