...
EXTERNALPROJECT_ADD(pcre2
  ...
  UPDATE_COMMAND "${CMAKE_COMMAND}" -E copy "${PROJECT_SOURCE_DIR}/3rdparty/tar/pcre2-10.22/CMakeLists_fixed.txt" "${CMAKE_CURRENT_BINARY_DIR}/pcre2/src/pcre2/CMakeLists.txt"
  PREFIX "${CMAKE_CURRENT_BINARY_DIR}/pcre2"
  CMAKE_ARGS "-DCMAKE_INSTALL_PREFIX:PATH=${3RDPARTY_OUTPUT_PATH}" "-DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}" -DBUILD_SHARED_LIBS=N -DPCRE2_BUILD_PCRE2_8=Y -DPCRE2_BUILD_PCRE2_16=N -DPCRE2_BUILD_PCRE2_32=N -DPCRE2_BUILD_PCRE2GREP=N -DPCRE2_BUILD_TESTS=N -DPCRE_STATIC_RUNTIME=1
  )
