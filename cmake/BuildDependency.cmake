MACRO (BuildDependency arg_name arg_srcdir arg_workdir arg_installprefix arg_cflags)
  #
  # Keep a copy of previous CFLAGS
  #
  IF ($ENV{CFLAGS})
    SET (BACKUP_CFLAGS $ENV{CFLAGS})
    SET (HAVE_BACKUP_CFLAGS TRUE)
  ELSE ()
    SET (BACKUP_CFLAGS "")
    SET (HAVE_BACKUP_CFLAGS FALSE)
  ENDIF ()
  SET (ENV{CFLAGS} "${BACKUP_CFLAGS} ${${arg_cflags}}")
  ...
  MESSAGE (STATUS "... Setting up ${arg_name}, generator ${CMAKE_GENERATOR}, build type ${CMAKE_BUILD_TYPE}, install prefix ${arg_installprefix}, cflags $ENV{CFLAGS}")
  EXECUTE_PROCESS(
