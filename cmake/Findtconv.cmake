...
IF(TCONV_FOUND)
  ...
  GET_FILENAME_COMPONENT(TCONV_DIRECTORY "${TCONV_LIBRARIES}" DIRECTORY CACHE)
  IF ("${CMAKE_HOST_SYSTEM}" MATCHES ".*Windows.*")
    SET (TCONV_RUNTIME_DIRECTORY "${TCONV_DIRECTORY}/../bin")
  ELSE ()
    SET (TCONV_RUNTIME_DIRECTORY "${TCONV_DIRECTORY}")
  ENDIF ()
  MESSAGE(STATUS "  RUNTIME_DIRECTORY: ${TCONV_RUNTIME_DIRECTORY}")
ENDIF()
