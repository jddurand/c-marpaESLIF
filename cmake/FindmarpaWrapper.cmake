...
IF (MARPAWRAPPER_INCLUDE_DIR)
  ...
  IF (NOT DEFINED _MARPAWRAPPER_MISSING_COMPONENTS)
  ...
  ELSE (NOT DEFINED _MARPAWRAPPER_MISSING_COMPONENTS)
    ...
    ENDFOREACH (_MARPAWRAPPER_MISSING_COMPONENT ${_MARPAWRAPPER_MISSING_COMPONENTS})
  ENDIF (NOT DEFINED _MARPAWRAPPER_MISSING_COMPONENTS)
...
IF(MARPAWRAPPER_FOUND)
  MESSAGE(STATUS "")
  MESSAGE(STATUS "marpaWrapper Setup:")
  MESSAGE(STATUS "-------------------")
  ...
  GET_FILENAME_COMPONENT(MARPAWRAPPER_DIRECTORY "${MARPAWRAPPER_LIBRARIES}" DIRECTORY CACHE)
  IF ("${CMAKE_HOST_SYSTEM}" MATCHES ".*Windows.*")
    SET (MARPAWRAPPER_RUNTIME_DIRECTORY "${MARPAWRAPPER_DIRECTORY}/../bin")
  ELSE ()
    SET (MARPAWRAPPER_RUNTIME_DIRECTORY "${MARPAWRAPPER_DIRECTORY}")
  ENDIF ()
  MESSAGE(STATUS "  RUNTIME_DIRECTORY: ${MARPAWRAPPER_RUNTIME_DIRECTORY}")
ENDIF()
