...
The L<marpaESLIF BNF|https://github.com/jddurand/c-marpaESLIF/doc/BNF> is inspired from L<Marpa::R2's DSL|https://metacpan.org/pod/distribution/Marpa-R2/pod/Scanless/DSL.pod>, though with some incompatible changes and many add-ons, in particular:
...
The ESLIF is nothing else but a I<sparse array> of grammars:

=head1 SEE ALSO

L<marpaESLIF BNF|https://github.com/jddurand/c-marpaESLIF/doc/BNF>
