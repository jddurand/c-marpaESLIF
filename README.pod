...
genericHash exposes hashing function and comparison functions. It is built on top of L<genericStack|https://github.com/jddurand/c-genericStack>.
...
=head2 GENERICHASH_NEW(hashName, indFunctionp, cmpFunctionp, unique)
