...
The following sections are a general presentation of marpaESLIF architecture, features, things-to-know. Please refer to the L<marpaESLIF API|https://github.com/jddurand/c-marpaESLIF/tree/master/doc/API> and L<marpaESLIF Tutoriql|https://github.com/jddurand/c-marpaESLIF/tree/master/doc/API> for precise and hopefully exhaustive documentation.
...
=head1 Terminals and Regular expression engine
...
... dand it is managed at I<valuation> phase.
