...
This project is L<CMake|http://cmake.org> based, version 3.26 at least. Recommended pattern is:

  cmake -Wno-dev -S c-marpaESLIF -B c-marpaESLIF-build -DCMAKE_BUILD_TYPE=RelWithDebInfo -DTCONV_USE_ICU=NO 
