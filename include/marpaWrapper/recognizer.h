...
extern "C" {
  ...
  marpaWrapper_EXPORT short                        marpaWrapperRecognizer_valueb(marpaWrapperRecognizer_t *marpaWrapperRecognizerp, short highRankOnlyb, short orderByRankb, short ambiguityb, short nullb);
