...
extern "C" {
  ...
  marpaESLIF_EXPORT short                         marpaESLIFRecognizer_contextLocationb(marpaESLIFRecognizer_t *marpaESLIFRecognizerp, int *contextip);
  marpaESLIF_EXPORT short                         marpaESLIFRecognizer_contextSetb(marpaESLIFRecognizer_t *marpaESLIFRecognizerp, int i);
  marpaESLIF_EXPORT short                         marpaESLIFRecognizer_contextGetb(marpaESLIFRecognizer_t *marpaESLIFRecognizerp, int contexti, int *ip);
  ...
  marpaESLIF_EXPORT short                        marpaESLIFSymbol_tryb(marpaESLIFSymbol_t *marpaESLIFSymbolp, char *inputs, size_t inputl, short *matchbp, char **bytepp, size_t *bytelp);
