...
extern "C" {
  ...
  MARPAESLIF_EXPORT short                   marpaESLIFRecognizer_lexeme_testb(marpaESLIFRecognizer_t *marpaESLIFRecognizerp, char *lexemes, marpaESLIFRecognizerOption_t *marpaESLIFRecognizerOptionp);
