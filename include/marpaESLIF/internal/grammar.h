...
typedef enum marpaESLIF_regex_option {
  ...
  MARPAESLIF_REGEX_OPTION_SUBSTITUTE_GLOBAL        = 0x1000, /* g */
  MARPAESLIF_REGEX_OPTION_SUBSTITUTE_UNKNOWN_UNSET = 0x2000, /* z */
  MARPAESLIF_REGEX_OPTION_SUBSTITUTE_UNSET_EMPTY   = 0x4000  /* Z */
...
struct marpaESLIF_regex_option_map {
  ...
  { MARPAESLIF_REGEX_OPTION_SUBSTITUTE_GLOBAL,              "g", PCRE2_SUBSTITUTE_GLOBAL },
  { MARPAESLIF_REGEX_OPTION_SUBSTITUTE_UNKNOWN_UNSET,       "z", PCRE2_SUBSTITUTE_UNKNOWN_UNSET },
  { MARPAESLIF_REGEX_OPTION_SUBSTITUTE_UNSET_EMPTY,         "Z", PCRE2_SUBSTITUTE_UNSET_EMPTY }
};
