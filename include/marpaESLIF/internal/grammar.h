...
typedef enum marpaESLIF_regex_option {
  ...
  MARPAESLIF_REGEX_OPTION_ANCHORED            = 0x0080, /* A */
  MARPAESLIF_REGEX_OPTION_DOLLAR_ENDONLY      = 0x0100, /* D */
  MARPAESLIF_REGEX_OPTION_DUPNAMES            = 0x0200, /* J */
  MARPAESLIF_REGEX_OPTION_UNGREEDY            = 0x0800, /* U */
  MARPAESLIF_REGEX_OPTION_GLOBAL              = 0x1000, /* g */
  MARPAESLIF_REGEX_OPTION_UNKNOWN_UNSET       = 0x2000, /* z */
  MARPAESLIF_REGEX_OPTION_UNSET_EMPTY         = 0x4000  /* Z */
...
typedef enum marpaESLIF_regex_option_id {
  ...
  MARPAESLIF_REGEX_OPTION_GLOBAL_ID,
  MARPAESLIF_REGEX_OPTION_UNKNOWN_UNSET_ID,
  MARPAESLIF_REGEX_OPTION_UNSET_EMPTY_ID,
...
struct marpaESLIF_regex_option_map {
  ...
  { MARPAESLIF_REGEX_OPTION_GLOBAL,              "g", PCRE2_SUBSTITUTE_GLOBAL },
  { MARPAESLIF_REGEX_OPTION_UNKNOWN_UNSET,       "z", PCRE2_SUBSTITUTE_UNKNOWN_UNSET },
  { MARPAESLIF_REGEX_OPTION_UNSET_EMPTY,         "Z", PCRE2_SUBSTITUTE_UNSET_EMPTY }
};
