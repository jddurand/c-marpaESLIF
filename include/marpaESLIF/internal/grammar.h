...
typedef enum marpaESLIF_regexp_option {
  MARPAESLIF_REGEXP_OPTION_NA                  = 0x0000,
  MARPAESLIF_REGEXP_OPTION_MATCH_UNSET_BACKREF = 0x0001, /* e */
  MARPAESLIF_REGEXP_OPTION_CASELESS            = 0x0002, /* i */
  MARPAESLIF_REGEXP_OPTION_JAVASCRIPT          = 0x0004, /* j */
  MARPAESLIF_REGEXP_OPTION_MULTILINE           = 0x0008, /* m */
  MARPAESLIF_REGEXP_OPTION_UTF_UCP             = 0x0010, /* n */
  MARPAESLIF_REGEXP_OPTION_DOTALL              = 0x0020, /* s */
  MARPAESLIF_REGEXP_OPTION_UTF                 = 0x0040, /* u */
  MARPAESLIF_REGEXP_OPTION_EXTENDED            = 0x0080, /* x */
  MARPAESLIF_REGEXP_OPTION_ANCHORED            = 0x0100, /* A */
  MARPAESLIF_REGEXP_OPTION_DOLLAR_ENDONLY      = 0x0200, /* D */
  MARPAESLIF_REGEXP_OPTION_DUPNAMES            = 0x0400, /* J */
  MARPAESLIF_REGEXP_OPTION_JIT                 = 0x0800, /* S - handled programmatically */
  MARPAESLIF_REGEXP_OPTION_UNGREEDY            = 0x1000  /* U */
...
typedef enum marpaESLIF_regexp_option_id {
  ...
  MARPAESLIF_REGEXP_OPTION_UTF_UCP_ID,
  MARPAESLIF_REGEXP_OPTION_DOTALL_ID,
  MARPAESLIF_REGEXP_OPTION_UTF_ID,
...
struct marpaESLIF_regexp_option_map {
  ...
  { MARPAESLIF_REGEXP_OPTION_UTF_UCP,             "n", PCRE2_UTF|PCRE2_UCP },
  { MARPAESLIF_REGEXP_OPTION_DOTALL,              "s", PCRE2_DOTALL },
  { MARPAESLIF_REGEXP_OPTION_UTF,                 "u", PCRE2_UTF },
