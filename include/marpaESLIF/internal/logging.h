...
#define MARPAESLIFRECOGNIZER_TRACEF(marpaESLIFRecognizerp, funcs, fmts, ...) \
  MARPAESLIF2LOG(marpaESLIFRecognizerp->marpaESLIFp, GENERICLOGGER_TRACEF(genericLoggerp, "[Level %2d Iter %3ld][%s%s] " fmts, marpaESLIFRecognizerp->marpaESLIFGrammarp->grammarp->leveli, marpaESLIFRecognizerp->resumeCounterl, funcs, marpaESLIFRecognizerp->discardb ? "/:discard" : "", __VA_ARGS__))
