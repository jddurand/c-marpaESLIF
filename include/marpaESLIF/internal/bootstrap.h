...
typedef enum _marpaESLIFBootstrapStackTypeEnum {
  ...
  marpaESLIFBootstrapStackTypeEnum_ADVERB_ITEM_SYMBOLGENERATORACTION,
...
#define MARPAESLIF_BOOTSTRAP_STACK_TYPE_ADVERB_ITEM_SYMBOLGENERATORACTION &(_MARPAESLIF_BOOTSTRAP_STACK_TYPE[marpaESLIFBootstrapStackTypeEnum_ADVERB_ITEM_SYMBOLGENERATORACTION])
...
enum marpaESLIF_bootstrap_adverb_list_item_type {
  ...
  MARPAESLIF_BOOTSTRAP_ADVERB_LIST_ITEM_TYPE_SYMBOLGENERATORACTION,
