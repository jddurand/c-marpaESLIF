...
typedef enum _marpaESLIFBootstrapStackTypeEnum {
  ...
  marpaESLIFBootstrapStackTypeEnum_ADVERB_ITEM_TERMINALS_ARE_EXCLUSIVE,
...
#define MARPAESLIF_BOOTSTRAP_STACK_TYPE_ADVERB_ITEM_TERMINALS_ARE_EXCLUSIVE &(_MARPAESLIF_BOOTSTRAP_STACK_TYPE[marpaESLIFBootstrapStackTypeEnum_ADVERB_ITEM_TERMINALS_ARE_EXCLUSIVE])
...
enum marpaESLIF_bootstrap_adverb_list_item_type {
  ...
  MARPAESLIF_BOOTSTRAP_ADVERB_LIST_ITEM_TYPE_TERMINALS_ARE_EXCLUSIVE,
