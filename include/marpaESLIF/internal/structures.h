...
struct marpaESLIFSymbol {
  ...
  char                          *luaexplists;
  char                          *luaexplistactions;
  short                          luaexplistcb;
  char                          *luaexplistcp;               /* Precompiled chunk. Not NULL only when luaexplistcb is true and call as been used at least once */
  size_t                         luaexplistcl;               /* Precompiled chunk length */
};
