...
struct marpaESLIF {
  ...
  char                    float_fmts[2048];            /* Pre-filled format string for floats */
  char                    double_fmts[2048];           /* Pre-filled format string for double */
  char                    long_double_fmts[2048];      /* Pre-filled format string for double */
};
