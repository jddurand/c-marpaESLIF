...
typedef enum    marpaESLIF_groupedregex_type_t   marpaESLIF_groupedregex_type_t;
typedef struct  marpaESLIF_groupedregex          marpaESLIF_groupedregex_t;
...
enum marpaESLIF_groupedregex_type_t {
  MARPAESLIF_GROUPEDREGEX_TYPE_NA = -1,
  MARPAESLIF_GROUPEDREGEX_TYPE_ANCHORED = 0,
  MARPAESLIF_GROUPEDREGEX_TYPE_ANCHORED_CASELESS,
  MARPAESLIF_GROUPEDREGEX_TYPE_ANCHORED_UTF,
  MARPAESLIF_GROUPEDREGEX_TYPE_ANCHORED_CASELESS_UTF,
  _MARPAESLIF_GROUPEDREGEX_TYPE_LAST
};

static marpaESLIF_uint32_t wantedRegexOptioni[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST] = {
  PCRE2_ANCHORED,
...
struct marpaESLIF_groupedregex {
  short                               doneb[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];                 /* Grouped regex done ? */
  short                               utfb[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];                  /* PCRE2_UTF regex ? */
  short                               jitCompleteOrPartialb[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST]; /* JIT complete+partial available ? */
  char                               *patterns[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];              /* Source pattern */
  pcre2_code                         *patternp[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];              /* Compiled pattern */
  pcre2_match_data                   *match_datap[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];           /* Match data */
  pcre2_compile_context              *compile_contextp[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];      /* Output of pcre2_compile_context */
  pcre2_match_context                *match_contextp[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];        /* Match context */
  marpaESLIF_pcre2_callout_context_t  callout_context[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];       /* Callout match */
  marpaESLIF_matcher_value_t          rci[_MARPAESLIF_GROUPEDREGEX_TYPE_LAST];                   /* Global match state */
};
...
struct marpaESLIFSymbol {
  ...
  marpaESLIF_matcher_value_t     groupedrci;             /* Individual symbol rci in grouped regex */
  char                          *groupedmatchp;
  size_t                         groupedmatchl;
  marpaESLIF_groupedregex_type_t groupedtype;
};
...
struct marpaESLIF_grammar {
  ...
  marpaESLIF_groupedregex_t          *groupedregexp;                      /* All grammar terminals in a single regexp */
};
...
struct marpaESLIF {
  ...
  short                       ZeroShortisZeroBytesb;       /* An internal boolean to help when we can safely do memset() */
