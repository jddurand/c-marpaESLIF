...
bootstrap_grammar_meta_t bootstrap_grammar_L0_metas[] = {
  ...
  { L0_META_INTEGER,                            "<meta integer>", 0, 0 },
  ...
  { L0_META_DOUBLE_COLON,                       "<meta double colon>", 0, 0 },
  ...
  { L0_META_ARRAY_DESCRIPTOR_LEFT_BRACKET,      "<meta array descriptor left bracket>", 0, 0 },
  { L0_META_ARRAY_DESCRIPTOR_RIGHT_BRACKET,     "<meta array descriptor right bracket>", 0, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR_LIST,        "<meta result item descriptor list>", 0, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR_SEPARATOR,   "<meta result item descriptor separator>", 0, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,             "<meta result item descriptor>", 0, 0 },
  { L0_META_SINGLE_QUOTED_STRING,               "<meta single quoted string>", 0, 0 },
  { L0_META_DOUBLE_QUOTED_STRING,               "<meta double quoted string>", 0, 0 },
  { L0_META_QUOTED_STRING,                      L0_JOIN_G1_META_QUOTED_STRING, 0, 0 },
  { L0_META_SINGLE_QUOTED_NAME,                 "<meta single quoted name>", 0, 0 },
  { L0_META_DOUBLE_QUOTED_NAME,                 "<meta double quoted name>", 0, 0 },
  ...
  { L0_META_SUBSTITUTION_EXPRESSION_MODIFIERS,  "<meta substitution expression modifiers>", 0, 0 }
};
