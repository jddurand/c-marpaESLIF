...
bootstrap_grammar_rule_t bootstrap_grammar_L0_rules[] = {
  { L0_META_RESERVED_EVENT_NAME,              "<rule reserved event name>",                MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_RESERVED_EVENT_NAME              }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_WHITESPACE,                       "<rule whitespace>",                         MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_WHITESPACE                       }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_PERL_COMMENT,                     "<rule perl comment>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_PERL_COMMENT                     }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_CPLUSPLUS_COMMENT,                "<rule cplusplus comment>",                  MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_CPLUSPLUS_COMMENT                }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_C_COMMENT,                        "<rule c comment>",                          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_C_COMMENT                        }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_OP_DECLARE_ANY_GRAMMAR,           "<rule op declare any grammar>",             MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_OP_DECLARE_ANY_GRAMMAR           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_OP_DECLARE_TOP_GRAMMAR,           "<rule op declare top grammar>",             MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_OP_DECLARE_TOP_GRAMMAR           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_OP_DECLARE_LEX_GRAMMAR,           "<rule op declare lex grammar>",             MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_OP_DECLARE_LEX_GRAMMAR           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_OP_LOOSEN,                        "<rule op loosen>",                          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_OP_LOOSEN                        }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_OP_EQUAL_PRIORITY,                "<rule op equal priority>",                  MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_OP_EQUAL_PRIORITY                }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_BEFORE_OR_AFTER,                  "<rule before or after 1>",                  MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_BEFORE                           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_BEFORE_OR_AFTER,                  "<rule before or after 2>",                  MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_AFTER                            }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_SIGNED_INTEGER,                   "<rule signed integer 1>",                   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_META_INTEGER                              }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_SIGNED_INTEGER,                   "<rule signed integer 2>",                   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_META_SIGN,
                                                                                                                                  L0_META_INTEGER                              }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_SIGN,                             "<rule sign>",                               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_SIGN                             }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_INTEGER,                          "<rule integer>",                            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_INTEGER                          }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_TRUE,                             "<rule true>",                               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_TRUE                             }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_BOOLEAN,                          "<rule boolean>",                            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_BOOLEAN                          }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_WORD_CHARACTER     ,              "<rule word character>",                     MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_WORD_CHARACTER                   }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESERVED_ACTION_NAME,             "<rule reserved action name>",               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_DOUBLE_COLON,
                                                                                                                                  L0_META_ONE_OR_MORE_WORD_CHARACTERS          }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_RESERVED_BLESSING_NAME,           "<rule reserved blessing name>",             MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_DOUBLE_COLON,
                                                                                                                                  L0_META_ONE_OR_MORE_WORD_CHARACTERS          }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_ONE_OR_MORE_WORD_CHARACTERS,      "<rule one more word characters>",           MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_WORD_CHARACTER                       }, { 1 },        1,                   -1,      -1, 0 },
  { L0_META_ZERO_OR_MORE_WORD_CHARACTERS,     "<rule zero more word characters>",          MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_WORD_CHARACTER                       }, { 1 },        0,                   -1,      -1, 0 },
  { L0_META_PERL_IDENTIFIER,                  "<rule perl identifier>",                    MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_WORD_CHARACTER                       }, { 1 },        1,                   -1,      -1, 0 },
  { L0_META_DOUBLE_COLON,                     "<rule double colon>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_DOUBLE_COLON                     }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_PERL_NAME,                        "<rule perl name>",                          MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_PERL_IDENTIFIER                      }, { 1 },        1, L0_META_DOUBLE_COLON,       1, 0 },
  { L0_META_BARE_NAME,                        "<rule bare name>",                          MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_WORD_CHARACTER                       }, { 1 },        1,                   -1,      -1, 0 },
  { L0_META_STANDARD_NAME,                    "<rule standard name>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_LATIN_ALPHABET_LETTER,
                                                                                                                                  L0_META_ZERO_OR_MORE_WORD_CHARACTERS         }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_BRACKETED_NAME,                   "<rule bracketed name>",                     MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { L0_TERMINAL_LEFT_CURLY,
                                                                                                                                  L0_META_BRACKETED_NAME_STRING,
                                                                                                                                  L0_TERMINAL_RIGHT_CURLY                      }, { 1, 1, 1 }, -1,                   -1,      -1, 0 },
  { L0_META_BRACKETED_NAME_STRING,            "<rule bracketed name string>",              MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_BRACKETED_NAME_STRING            }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_ARRAY_DESCRIPTOR,                 "<rule array descriptor>",                   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { L0_META_ARRAY_DESCRIPTOR_LEFT_BRACKET,
                                                                                                                                  L0_META_RESULT_ITEM_DESCRIPTOR_LIST,
                                                                                                                                  L0_META_ARRAY_DESCRIPTOR_RIGHT_BRACKET       }, { 1, 1, 1 }, -1,                   -1,      -1, 0 },
  { L0_META_ARRAY_DESCRIPTOR_LEFT_BRACKET,    "<rule array descriptor left bracket 1>",    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_ARRAY_DESCRIPTOR_LEFT_BRACKET    }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_ARRAY_DESCRIPTOR_LEFT_BRACKET,    "<rule array descriptor left bracket 2>",    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_ARRAY_DESCRIPTOR_LEFT_BRACKET,
                                                                                                                                  L0_META_WHITESPACE                           }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_ARRAY_DESCRIPTOR_RIGHT_BRACKET,   "<rule array descriptor right bracket 1>",   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_ARRAY_DESCRIPTOR_RIGHT_BRACKET   }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_ARRAY_DESCRIPTOR_RIGHT_BRACKET,   "<rule array descriptor right bracket 2>",   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_META_WHITESPACE,
                                                                                                                                  L0_TERMINAL_ARRAY_DESCRIPTOR_RIGHT_BRACKET   }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR_LIST,      "<rule result item descriptor list>",        MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_RESULT_ITEM_DESCRIPTOR               }, { 1 },        0, L0_META_RESULT_ITEM_DESCRIPTOR_SEPARATOR, 0, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR_SEPARATOR, "<rule result item descriptor separator 1>", MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_COMMA                            }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR_SEPARATOR, "<rule result item descriptor separator 2>", MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_COMMA,
                                                                                                                                  L0_META_WHITESPACE                           }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  1>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_START                            }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  2>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_LENGTH                           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  3>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_G1START                          }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  4>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_G1LENGTH                         }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  5>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_NAME                             }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  6>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_LHS                              }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  7>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_SYMBOL                           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  8>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_RULE                             }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor  9>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_VALUE                            }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_RESULT_ITEM_DESCRIPTOR,           "<rule result item descriptor 10>",          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_VALUES                           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_SINGLE_QUOTED_STRING,             "<rule single quoted string>",               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_SINGLE_QUOTED_STRING,
                                                                                                                                  L0_META_CHARACTER_CLASS_MODIFIERS            }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_DOUBLE_QUOTED_STRING,             "<rule double quoted string>",               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_TERMINAL_DOUBLE_QUOTED_STRING,
                                                                                                                                  L0_META_CHARACTER_CLASS_MODIFIERS            }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_QUOTED_STRING,                    "<rule quoted string 1>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_META_SINGLE_QUOTED_STRING                 }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_QUOTED_STRING,                    "<rule quoted string 2>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_META_DOUBLE_QUOTED_STRING                 }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_SINGLE_QUOTED_NAME,               "<rule single quoted name>",                 MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_SINGLE_QUOTED_STRING             }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_DOUBLE_QUOTED_NAME,               "<rule double quoted name>",                 MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_DOUBLE_QUOTED_STRING             }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_QUOTED_NAME,                      "<rule quoted name 1>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_META_SINGLE_QUOTED_NAME                   }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_QUOTED_NAME,                      "<rule quoted name 2>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_META_DOUBLE_QUOTED_NAME                   }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_CHARACTER_CLASS_REGEXP,           "<rule character class regexp>",             MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_CHARACTER_CLASS_REGEXP           }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_CHARACTER_CLASS,                  "<rule character class>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_META_CHARACTER_CLASS_REGEXP,
																  L0_META_CHARACTER_CLASS_MODIFIERS            }, { 1, 1 },    -1,                   -1,      -1, 0 },
  { L0_META_CHARACTER_CLASS_MODIFIER,         "<rule character class modifier standard>",  MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_CHARACTER_CLASS_MODIFIER_STANDARD}, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_CHARACTER_CLASS_MODIFIER,         "<rule character class modifier compat>",    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_CHARACTER_CLASS_MODIFIER_COMPAT  }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_CHARACTER_CLASS_MODIFIERS,        "<rule character class modifiers>",          MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_META_CHARACTER_CLASS_MODIFIER             }, { 1 },        0,                   -1,       0, 0 },
  { L0_META_REGULAR_EXPRESSION,               "<rule regular expression>",                 MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_REGULAR_EXPRESSION               }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_REGULAR_EXPRESSION_MODIFIERS,     "<rule regular expression modifiers>",       MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_TERMINAL_REGULAR_EXPRESSION_MODIFIER      }, { 1 },        0,                   -1,       0, 0 },
  { L0_META_SUBSTITUTION_EXPRESSION,          "<rule substitution expression>",            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_SUBSTITUTION_EXPRESSION          }, { 1 },       -1,                   -1,      -1, 0 },
  { L0_META_SUBSTITUTION_EXPRESSION_MODIFIERS,"<rule substitution expression modifiers>",  MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { L0_TERMINAL_SUBSTITUTION_EXPRESSION_MODIFIER }, { 1 },        0,                   -1,       0, 0 }
};
