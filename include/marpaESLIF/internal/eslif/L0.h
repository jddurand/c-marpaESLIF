...
bootstrap_grammar_rule_t bootstrap_grammar_L0_rules[] = {
  ...
  { L0_META_SINGLE_QUOTED_STRING,             "<rule single quoted string>",               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_SINGLE_QUOTED_STRING             }, { 1 },       -1,                   -1,      -1 },
  { L0_META_DOUBLE_QUOTED_STRING,             "<rule double quoted string>",               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { L0_TERMINAL_DOUBLE_QUOTED_STRING             }, { 1 },       -1,                   -1,      -1 },
  { L0_META_QUOTED_STRING,                    "<rule quoted string>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 2, { L0_META_SINGLE_QUOTED_STRING,
																  L0_META_DOUBLE_QUOTED_STRING                 }, { 1, 1 },    -1,                   -1,      -1 },
