...
bootstrap_grammar_meta_t bootstrap_grammar_L0_metas[] = {
  { L0_META_RESERVED_EVENT_NAME,                L0_JOIN_G1_META_RESERVED_EVENT_NAME },
  ...
  { L0_META_OP_DECLARE_ANY_GRAMMAR,             L0_JOIN_G1_META_OP_DECLARE_ANY_GRAMMAR },
  { L0_META_OP_DECLARE_TOP_GRAMMAR,             L0_JOIN_G1_META_OP_DECLARE_TOP_GRAMMAR },
  { L0_META_OP_DECLARE_LEX_GRAMMAR,             L0_JOIN_G1_META_OP_DECLARE_LEX_GRAMMAR },
  { L0_META_OP_LOOSEN,                          L0_JOIN_G1_META_OP_LOOSEN },
  { L0_META_OP_EQUAL_PRIORITY,                  L0_JOIN_G1_META_OP_EQUAL_PRIORITY },
  { L0_META_BEFORE_OR_AFTER,                    L0_JOIN_G1_META_BEFORE_OR_AFTER },
  { L0_META_SIGNED_INTEGER,                     L0_JOIN_G1_META_SIGNED_INTEGER },
  { L0_META_SIGN,                               "<meta sign>" },
  { L0_META_INTEGER,                            "<meta integer>" },
  { L0_META_TRUE,                               L0_JOIN_G1_META_TRUE },
  { L0_META_BOOLEAN,                            L0_JOIN_G1_META_BOOLEAN },
  { L0_META_WORD_CHARACTER,                     "<meta word character>" },
  { L0_META_RESERVED_ACTION_NAME,               L0_JOIN_G1_META_RESERVED_ACTION_NAME },
  { L0_META_RESERVED_BLESSING_NAME,             L0_JOIN_G1_META_RESERVED_BLESSING_NAME },
  ...
  { L0_META_PERL_NAME,                          L0_JOIN_G1_META_PERL_NAME },
  { L0_META_BARE_NAME,                          L0_JOIN_G1_META_BARE_NAME },
  { L0_META_STANDARD_NAME,                      L0_JOIN_G1_META_STANDARD_NAME },
  { L0_META_BRACKETED_NAME,                     L0_JOIN_G1_META_BRACKETED_NAME },
  { L0_META_BRACKETED_NAME_STRING,              "<meta bracketed name string>" },
  { L0_META_ARRAY_DESCRIPTOR,                   L0_JOIN_G1_META_ARRAY_DESCRIPTOR },
  ...
  { L0_META_QUOTED_STRING,                      L0_JOIN_G1_META_QUOTED_STRING },
  { L0_META_SINGLE_QUOTED_NAME,                 "<meta single quoted name>" },
  { L0_META_DOUBLE_QUOTED_NAME,                 "<meta double quoted name>" },
  { L0_META_QUOTED_NAME,                        L0_JOIN_G1_META_QUOTED_NAME },
  { L0_META_CHARACTER_CLASS_REGEXP,             "<meta character class regexp>" },
  { L0_META_CHARACTER_CLASS,                    L0_JOIN_G1_META_CHARACTER_CLASS },
  ...
  { L0_META_REGULAR_EXPRESSION,                 L0_JOIN_G1_META_REGULAR_EXPRESSION },
  { L0_META_REGULAR_EXPRESSION_MODIFIERS,       "<meta regular expression modifiers>" },
  { L0_META_SUBSTITUTION_EXPRESSION,            L0_JOIN_G1_META_SUBSTITUTION_EXPRESSION },
