...
bootstrap_grammar_terminal_t bootstrap_grammar_G1_terminals[] = {
  ...
  /*                                                             TERMINALS                                                             */
  /* --------------------------------------------------------------------------------------------------------------------------------- */
  { G1_TERMINAL__START, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':start'", NULL, NULL,
  ...
  { G1_TERMINAL__DESC, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':desc'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":desc", ":de"
#else
  ...
  { G1_TERMINAL_SEMICOLON, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "';'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ";", ""
#else
  ...
  { G1_TERMINAL_LEFT_BRACKET, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'{'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "{", ""
#else
  ...
  { G1_TERMINAL_RIGHT_BRACKET, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'}'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "}", ""
#else
  ...
  { G1_TERMINAL__DISCARD, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':discard'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":discard", ":dis"
#else
  ...
  { G1_TERMINAL__DEFAULT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':default'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":default", ":def"
#else
  ...
  { G1_TERMINAL_DEFAULT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'default'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "default", "def"
#else
  ...
  { G1_TERMINAL_EQUAL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'='", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "=", ""
#else
  ...
  { G1_TERMINAL__LEXEME, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':lexeme'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":lexeme", ":lexe"
#else
  ...
  { G1_TERMINAL__TERMINAL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':terminal'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":terminal", ":term"
#else
  ...
  { G1_TERMINAL_EVENT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'event'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "event", "eve"
#else
  ...
  { G1_TERMINAL_COMPLETED, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'completed'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "completed", "comp"
#else
  ...
  { G1_TERMINAL_NULLED, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'nulled'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "nulled", "nul"
#else
  ...
  { G1_TERMINAL_PREDICTED, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'predicted'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "predicted", "pre"
#else
  ...
  { G1_TERMINAL_IS, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'is'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "is", "i"
#else
  ...
  { G1_TERMINAL_INACCESSIBLE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_BY, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'by'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "by", "b"
#else
  ...
  { G1_TERMINAL_WARN, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'warn'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "warn", "wa"
#else
  ...
  { G1_TERMINAL_OK,  MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'ok'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "ok", "o"
#else
  ...
  { G1_TERMINAL_FATAL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'fatal'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "fatal", "fata"
#else
  ...
  { G1_TERMINAL_MINUS, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'-'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "-", ""
#else
  ...
  { G1_TERMINAL_ACTION, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'action'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "action", "act"
#else
  ...
  { G1_TERMINAL_SYMBOL_ACTION, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_THEN, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, "u",
    "=>|\\x{21D2}", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "\xE2\x87\x92", "="
#else
  ...
  { G1_TERMINAL_AUTORANK, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'autorank'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "autorank", "auto"
#else
  ...
  { G1_TERMINAL_ASSOC, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'assoc'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "assoc", "asso"
#else
  ...
  { G1_TERMINAL_LEFT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'left'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "left", "lef"
#else
  ...
  { G1_TERMINAL_RIGHT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'right'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "right", "r"
#else
  ...
  { G1_TERMINAL_GROUP, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'group'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "group", "gr"
#else
  ...
  { G1_TERMINAL_SEPARATOR, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'separator'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "separator", "sep"
#else
  ...
  { G1_TERMINAL_PROPER, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'proper'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "proper", "pro"
#else
  ...
  { G1_TERMINAL_VERBOSE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'verbose'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "verbose", "verb"
#else
  ...
  { G1_TERMINAL_HIDESEPARATOR, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_RANK, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'rank'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "rank", "ra"
#else
  ...
  { G1_TERMINAL_NULL_RANKING, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_NULL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'null'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "null", "nul"
#else
  ...
  { G1_TERMINAL_LOW, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'low'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "low", "lo"
#else
  ...
  { G1_TERMINAL_HIGH, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'high'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "high", "hi"
#else
  ...
  { G1_TERMINAL_PRIORITY, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'priority'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "priority", "prio"
#else
  ...
  { G1_TERMINAL_PAUSE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'pause'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "pause", "pa"
#else
  ...
  { G1_TERMINAL_ON, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'on'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "on", "o"
#else
  ...
  { G1_TERMINAL_OFF, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'off'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "off", "of"
#else
  ...
  { G1_TERMINAL_LATM, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'latm'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "latm", "lat"
#else
  ...
  { G1_TERMINAL_DISCARD_IS_FALLBACK, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_BLESS, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'bless'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "bless", "bl"
#else
  ...
  { G1_TERMINAL_NAME, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'name'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "name", "nam"
#else
  ...
  { G1_TERMINAL_COMMA, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "','", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ",", ""
#else
  ...
  { G1_TERMINAL_LPAREN, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'('", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "(", ""
#else
  ...
  { G1_TERMINAL_RPAREN, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "')'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ")", ""
#else
  ...
  { G1_TERMINAL_HIDE_LEFT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'(-'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "(-", "("
#else
  ...
  { G1_TERMINAL_HIDE_RIGHT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'-)'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "-)", "-"
#else
  ...
  { G1_TERMINAL_LOOKAHEAD_LEFT, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "\\(\\?[=!]", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "(?=", "("
#else
  ...
  { G1_TERMINAL_LOOKAHEAD_RIGHT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "')'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ")", NULL
#else
  ...
  { G1_TERMINAL_STAR, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'*'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "*", ""
#else
  ...
  { G1_TERMINAL_PLUS, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'+'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "+", ""
#else
  ...
  { G1_TERMINAL___SHIFT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::shift'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::shift", "::s"
#else
  ...
  { G1_TERMINAL___TRANSFER, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::transfer'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::transfer", "::tra"
#else
  ...
  { G1_TERMINAL___UNDEF, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::undef'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::undef", ":"
#else
  ...
  { G1_TERMINAL___ASCII, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::ascii'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::ascii", "::asci"
#else
  ...
  { G1_TERMINAL___CONVERT, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "::convert\\[[^\\]]+\\]", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
  ...
  { G1_TERMINAL___CONCAT, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::concat'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::concat", "::c"
#else
  ...
  { G1_TERMINAL___COPY, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "::copy\\[\\d+\\]", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::copy[2]", "::c"
#else
  ...
  { G1_TERMINAL_LEFT_ANGLE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'<'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "<", NULL
#else
  ...
  { G1_TERMINAL_RIGHT_ANGLE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'>'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ">", NULL
#else
  ...
  { G1_TERMINAL_AT_SIGN, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'@'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "@", NULL
#else
  ...
  { G1_TERMINAL__SYMBOL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':symbol'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":symbol", ":symb"
#else
  ...
  { G1_TERMINAL_BEFORE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'before'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "before", "bef"
#else
  ...
  { G1_TERMINAL_AFTER, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'after'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "after", "afte"
#else
  ...
  { G1_TERMINAL_SIGNED_INTEGER, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "[+-]?\\d+", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "-10", "+"
#else
  ...
  { G1_TERMINAL_UNSIGNED_INTEGER, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "\\d+", NULL, NULL,
    NULL, NULL
  },
  { G1_TERMINAL__DISCARD_ON, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL__DISCARD_OFF, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL__DISCARD_SWITCH, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_STRING_LITERAL_START, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::u8\"'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::u8\"", "::u8"
#else
  ...
  { G1_TERMINAL_STRING_LITERAL_END, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'\"'", NULL, NULL,
    NULL, NULL
  },
  { G1_TERMINAL_BACKSLASH, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'\\\\'", NULL, NULL,
    NULL, NULL
  },
  { G1_TERMINAL_STRING_LITERAL_NOT_ESCAPED, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "[^\"\\\\\\n]", NULL, NULL,
    NULL, NULL
  },
  { G1_TERMINAL_STRING_LITERAL_ESCAPED_CHAR, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "[\"'?\\\\abfnrtve]", NULL, NULL,
    NULL, NULL
  },
  { G1_TERMINAL_STRING_LITERAL_ESCAPED_HEX, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_STRING_LITERAL_ESCAPED_CODEPOINT, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_STRING_LITERAL_ESCAPED_LARGE_CODEPOINT, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_DOUBLE_QUOTE_CHARACTER, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'\"'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "\"", NULL
#else
  ...
  { G1_TERMINAL_SPACE_CHARACTER, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "' '", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    " ", NULL
#else
  ...
  { G1_TERMINAL_LUASCRIPT_TAG_START, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'<luascript>'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "<luascript>", "<luascript"
#else
  ...
  { G1_TERMINAL_LUASCRIPT_TAG_END, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'</luascript>'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "</luascript>", "</luascript"
#else
  ...
  { G1_TERMINAL_ANY_CHARACTER, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "[\\s\\S]", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "\n", NULL
#else
  ...
  { G1_TERMINAL___TRUE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::true'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::true", "::tru"
#else
  ...
  { G1_TERMINAL___FALSE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::false'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::false", "::fal"
#else
  ...
  { G1_TERMINAL___JSON, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::json'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::json", "::jso"
#else
  ...
  { G1_TERMINAL___JSONF, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::jsonf'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::jsonf", "::json"
#else
  ...
  { G1_TERMINAL___ROW, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::row'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::row", "::ro"
#else
  ...
  { G1_TERMINAL___TABLE, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::table'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::table", "::ta"
#else
  ...
  { G1_TERMINAL_IF_ACTION, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'if-action'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "if-action", "i"
#else
  ...
  { G1_TERMINAL_REGEX_ACTION, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_GENERATOR_ACTION, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'.'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ".", NULL
#else
  ...
  { G1_TERMINAL___AST, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'::ast'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "::ast", "::a"
#else
  ...
  { G1_TERMINAL_EVENT_ACTION, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_DEFAULT_ENCODING, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_FALLBACK_ENCODING, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL__EOF, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':eof'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":eof", ":eo"
#else
  ...
  { G1_TERMINAL__EOL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':eol'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":eol", ":eo"
#else
  ...
  { G1_TERMINAL__SOL, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "':sol'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    ":sol", ":so"
#else
  ...
  { G1_TERMINAL_WHITESPACE, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, "u",
    "[\\s]+", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "\x09\x20xxx", "\x09\x20"
#else
  ...
  { G1_TERMINAL_PERL_COMMENT, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, "u",
    "#[^\\n]*", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
  ...
  /* Perl stringified version is: (?:(?:(?://)(?:[^\n]*)(?:\n))|(?:(?:\/\*)(?:(?:[^\*]+|\*(?!\/))*)(?:\*\/))) */
  { G1_TERMINAL_CPLUSPLUS_COMMENT, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, "u",
    "//[^\\n]*|/\\*(?:[^\\*]+|\\*(?!/))*\\*/", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "// Comment up to the end of the buffer", "// Again a comment"
#else
  ...
  { G1_TERMINAL_LUA_FUNCTION, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
  ...
  { G1_TERMINAL_LUA_FUNCTIONCALL, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "\\-\\-?>\\(", NULL, ":discard[switch]",
#ifndef MARPAESLIF_NTRACE
    "-->(", "->"
#else
  ...
  { G1_TERMINAL_LUA_FUNCTIONDECL, MARPAESLIF_TERMINAL_TYPE_REGEX, 0 /* charclassb */, NULL,
    "<\\-\\-?\\(", NULL, ":discard[switch]",
#ifndef MARPAESLIF_NTRACE
    "<--(", "<-"
#else
  ...
  { G1_TERMINAL_DOLLAR, MARPAESLIF_TERMINAL_TYPE_STRING, 0 /* charclassb */, NULL,
    "'$'", NULL, NULL,
#ifndef MARPAESLIF_NTRACE
    "$", NULL
#else
