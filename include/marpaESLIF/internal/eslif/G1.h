...
bootstrap_grammar_meta_t bootstrap_grammar_G1_metas[] = {
  { G1_META_STATEMENTS,                       "<meta statements>", 1, 0 },
  { G1_META_STATEMENT,                        "<meta statement>", 0, 0 },
  { G1_META_START_RULE,                       "<meta start rule>", 0, 0 },
  { G1_META_DESC_RULE,                        "<meta desc rule>", 0, 0 },
  { G1_META_EMPTY_RULE,                       "<meta empty rule>", 0, 0 },
  { G1_META_NULL_STATEMENT,                   "<meta null statement>", 0, 0 },
  { G1_META_STATEMENT_GROUP,                  "<meta statement group>", 0, 0 },
  { G1_META_PRIORITY_RULE,                    "<meta priority rule>", 0, 0 },
  { G1_META_QUANTIFIED_RULE,                  "<meta quantified rule>", 0, 0 },
  { G1_META_DISCARD_RULE,                     "<meta discard rule>", 0, 0 },
  { G1_META_DEFAULT_RULE,                     "<meta default rule>", 0, 0 },
  { G1_META_LEXEME_DEFAULT_STATEMENT,         "<meta lexeme default statement>", 0, 0 },
  { G1_META_DISCARD_DEFAULT_STATEMENT,        "<meta discard default statement>", 0, 0 },
  { G1_META_LEXEME_RULE,                      "<meta lexeme rule>", 0, 0 },
  { G1_META_COMPLETION_EVENT_DECLARATION,     "<meta completion event declaration>", 0, 0 },
  { G1_META_NULLED_EVENT_DECLARATION,         "<meta nulled event declaration>", 0, 0 },
  { G1_META_PREDICTION_EVENT_DECLARATION,     "<meta prediction event declaration>", 0, 0 },
  { G1_META_CURRENT_LEXER_STATEMENT,          "<meta current lexer statement>", 0, 0 },
  { G1_META_INACCESSIBLE_STATEMENT,           "<meta inaccessible statement>", 0, 0 },
  { G1_META_INACCESSIBLE_TREATMENT,           "<meta inaccessible treatment>", 0, 0 },
  { G1_META_EXCEPTION_STATEMENT,              "<meta exception statement>", 0, 0 },
  { G1_META_OP_DECLARE,                       "<meta op declare>", 0, 0 },
  ...
  { G1_META_PRIORITIES,                       "<meta priorities>", 0, 0 },
  { G1_META_ALTERNATIVES,                     "<meta alternatives>", 0, 0 },
  { G1_META_ALTERNATIVE,                      "<meta alternative>", 0, 0 },
  { G1_META_ADVERB_LIST,                      "<meta adverb list>", 0, 0 },
  { G1_META_ADVERB_LIST_ITEMS,                "<meta adverb list items>", 0, 0 },
  { G1_META_ADVERB_ITEM,                      "<meta adverb item>", 0, 0 },
  { G1_META_ACTION,                           "<meta action>", 0, 0 },
  { G1_META_AUTORANK,                         "<meta autorank>", 0, 0 },
  { G1_META_LEFT_ASSOCIATION,                 "<meta left association>", 0, 0 },
  { G1_META_RIGHT_ASSOCIATION,                "<meta right association>", 0, 0 },
  { G1_META_GROUP_ASSOCIATION,                "<meta group association>", 0, 0 },
  { G1_META_SEPARATOR_ASSOCIATION,            "<meta separator association>", 0, 0 },
  { G1_META_PROPER_ASSOCIATION,               "<meta proper association>", 0, 0 },
  { G1_META_RANK_SPECIFICATION,               "<meta rank specification>", 0, 0 },
  { G1_META_NULL_RANKING_SPECIFICATION,       "<meta null ranking specification>", 0, 0 },
  { G1_META_NULL_RANKING_CONSTANT,            "<meta null ranking constant>", 0, 0 },
  { G1_META_PRIORITY_SPECIFICATION,           "<meta priority specification>", 0, 0 },
  { G1_META_PAUSE_SPECIFICATION,              "<meta pause specification>", 0, 0 },
  { G1_META_EVENT_SPECIFICATION,              "<meta event specification>", 0, 0 },
  { G1_META_EVENT_INITIALIZATION,             "<meta event initialization>", 0, 0 },
  { G1_META_EVENT_INITIALIZER,                "<meta event initializer>", 0, 0 },
  { G1_META_ON_OR_OFF,                        "<meta on or off>", 0, 0 },
  { G1_META_LATM_SPECIFICATION,               "<meta latm specification>", 0, 0 },
  { G1_META_BLESSING,                         "<meta blessing>", 0, 0 },
  { G1_META_BLESSING_NAME,                    "<meta blessing name>", 0, 0 },
  { G1_META_NAMING,                           "<meta naming>", 0, 0 },
  { G1_META_NULL_ADVERB,                      "<meta null adverb>", 0, 0 },
  { G1_META_ALTERNATIVE_NAME,                 "<meta alternative name>", 0, 0 },
  { G1_META_LEXER_NAME,                       "<meta lexer name>", 0, 0 },
  { G1_META_EVENT_NAME,                       "<meta event name>", 0, 0 },
  { G1_META_LHS,                              "<meta lhs>", 0, 0 },
  { G1_META_RHS,                              "<meta rhs>", 0, 0 },
  { G1_META_RHS_PRIMARY,                      "<meta rhs primary>", 0, 0 },
  { G1_META_PARENTHESIZED_RHS_PRIMARY_LIST,   "<meta parenthesized rhs primary list>", 0, 0 },
  { G1_META_RHS_PRIMARY_LIST,                 "<meta rhs primary list>", 0, 0 },
  { G1_META_PARENTHESIZED_RHS_EXCEPTION_LIST, "<meta parenthesized rhs exception list>", 0, 0 },
  { G1_META_RHS_EXCEPTION_LIST,               "<meta rhs exception list>", 0, 0 },
  { G1_META_RHS_EXCEPTION,                    "<meta rhs exception>", 0, 0 },
  { G1_META_SINGLE_SYMBOL,                    "<meta single symbol>", 0, 0 },
  { G1_META_SYMBOL,                           "<meta symbol>", 0, 0 },
  { G1_META_SYMBOL_NAME,                      "<meta symbol name>", 0, 0 },
  { G1_META_ACTION_NAME,                      "<meta action name>", 0, 0 },
  { G1_META_QUANTIFIER,                       "<meta quantifier>", 0, 0 },
  { G1_META_DISCARD,                          "<meta discard>", 0, 1 },
  /* L0 join */
...
bootstrap_grammar_terminal_t bootstrap_grammar_G1_terminals[] = {
  ...
  { G1_TERMINAL__DESC,
    "<terminal :desc>",               MARPAESLIF_TERMINAL_TYPE_STRING,  MARPAESLIF_REGEX_OPTION_NA,
    ":desc",
#ifndef MARPAESLIF_NTRACE
    ":desc", ":de"
#else
...
bootstrap_grammar_rule_t bootstrap_grammar_G1_rules[] = {
  ...
  */
  ...
  { G1_META_STATEMENT,                        "<rule statement 02>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_DESC_RULE                            }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 03>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_EMPTY_RULE                           }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 04>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_NULL_STATEMENT                       }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_STATEMENT,                        "<rule statement 05>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_STATEMENT_GROUP                      }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 06>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_PRIORITY_RULE                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 07>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_QUANTIFIED_RULE                      }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 08>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_DISCARD_RULE                         }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 09>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_DEFAULT_RULE                         }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_STATEMENT,                        "<rule statement 10>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_LEXEME_DEFAULT_STATEMENT             }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 11>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_DISCARD_DEFAULT_STATEMENT            }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 12>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_LEXEME_RULE                          }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 13>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_COMPLETION_EVENT_DECLARATION         }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 14>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_NULLED_EVENT_DECLARATION             }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_STATEMENT,                        "<rule statement 15>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_PREDICTION_EVENT_DECLARATION         }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 16>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_CURRENT_LEXER_STATEMENT              }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 17>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_INACCESSIBLE_STATEMENT               }, { 1 },            -1,                        -1, -1 },
  { G1_META_STATEMENT,                        "<rule statement 18>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_EXCEPTION_STATEMENT                  }, { 1 },            -1,                        -1, -1 },
  ...
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_DESC_RULE,                        "<rule desc rule 1>",                        MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { G1_TERMINAL__DESC,
                                                                                                                                  G1_META_OP_DECLARE,
                                                                                                                                  G1_META_QUOTED_NAME                          }, { 0, 0, 1},       -1,                        -1, -1 },
  { G1_META_DESC_RULE,                        "<rule desc rule 2>",                        MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { G1_TERMINAL__DESC,
                                                                                                                                  G1_META_OP_DECLARE,
  ...
  */
  ...
  { G1_META_NULL_RANKING_CONSTANT,            "<rule null ranking constant 1>",            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_LOW                              }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_NULL_RANKING_CONSTANT,            "<rule null ranking constant 2>",            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_HIGH                             }, { 1 },            -1,                        -1, -1 },
  ...
  */
  ...
  { G1_META_ON_OR_OFF,                        "<rule on or off 1>",                        MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_ON                               }, { 1 },            -1,                        -1, -1 },
  { G1_META_ON_OR_OFF,                        "<rule on or off 2>",                        MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_OFF                              }, { 1 },            -1,                        -1, -1 },
  { G1_META_EVENT_INITIALIZER,                "<rule event initializer 2>",                MARPAESLIF_RULE_TYPE_ALTERNATIVE, 0, { -1                                           }, {-1 },            -1,                        -1, -1 },
  ...
  */
  ...
  { G1_META_NULL_ADVERB,                      "<rule null adverb>",                        MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_COMMA                            }, { 1 },            -1,                        -1, -1 },
  { G1_META_ALTERNATIVE_NAME,                 "<rule alternative name 1>",                 MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_STANDARD_NAME                        }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_ALTERNATIVE_NAME,                 "<rule alternative name 2>",                 MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_QUOTED_NAME                          }, { 1 },            -1,                        -1, -1 },
  { G1_META_LEXER_NAME,                       "<rule lexer name 1>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_STANDARD_NAME                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_LEXER_NAME,                       "<rule lexer name 2>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_QUOTED_NAME                          }, { 1 },            -1,                        -1, -1 },
  { G1_META_EVENT_NAME,                       "<rule event name 1>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_STANDARD_NAME                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_EVENT_NAME,                       "<rule event name 2>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_QUOTED_NAME                          }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_EVENT_NAME,                       "<rule event name 3>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_RESERVED_EVENT_NAME                  }, { 1 },            -1,                        -1, -1 },
  { G1_META_BLESSING_NAME,                    "<rule blessing name 1>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_STANDARD_NAME                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_BLESSING_NAME,                    "<rule blessing name 2>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_RESERVED_BLESSING_NAME               }, { 1 },            -1,                        -1, -1 },
  { G1_META_LHS,                              "<rule lhs>",                                MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_SYMBOL_NAME                          }, { 1 },            -1,                        -1, -1 },
  { G1_META_RHS,                              "<rule rhs>",                                MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { G1_META_RHS_PRIMARY                          }, { 1 },             1,                        -1,  0 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_RHS_PRIMARY,                      "<rule rhs primary 1>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_SINGLE_SYMBOL                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_RHS_PRIMARY,                      "<rule rhs primary 2>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_QUOTED_STRING                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_RHS_PRIMARY,                      "<rule rhs primary 3>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_PARENTHESIZED_RHS_PRIMARY_LIST       }, { 1 },            -1,                        -1, -1 },
  ...
  { G1_META_RHS_PRIMARY_LIST,                 "<rule rhs primary list>",                   MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { G1_META_RHS_PRIMARY                          }, { 1 },             1,                        -1,  0 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_PARENTHESIZED_RHS_EXCEPTION_LIST, "<rule parenthesized rhs exception list>",   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { G1_TERMINAL_LPAREN,
                                                                                                                                  G1_META_RHS_EXCEPTION_LIST,
                                                                                                                                  G1_TERMINAL_RPAREN                           }, { 0, 1, 0},       -1,                        -1, -1 },
  { G1_META_RHS_EXCEPTION_LIST,               "<rule rhs exception list>",                 MARPAESLIF_RULE_TYPE_SEQUENCE,    1, { G1_META_RHS_EXCEPTION                        }, { 1 },             1,                        -1,  0 },
  { G1_META_RHS_EXCEPTION,                    "<rule rhs exception 1>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_QUOTED_STRING                        }, { 1 },            -1,                        -1, -1 },
  { G1_META_RHS_EXCEPTION,                    "<rule rhs exception 2>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_CHARACTER_CLASS                      }, { 1 },            -1,                        -1, -1 },
  { G1_META_RHS_EXCEPTION,                    "<rule rhs exception 3>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_REGULAR_EXPRESSION                   }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_SINGLE_SYMBOL,                    "<rule single symbol 1>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_SYMBOL_NAME                          }, { 1 },            -1,                        -1, -1 },
  { G1_META_SINGLE_SYMBOL,                    "<rule single symbol 2>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_CHARACTER_CLASS                      }, { 1 },            -1,                        -1, -1 },
  { G1_META_SINGLE_SYMBOL,                    "<rule single symbol 3>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_REGULAR_EXPRESSION                   }, { 1 },            -1,                        -1, -1 },
  { G1_META_SINGLE_SYMBOL,                    "<rule single symbol 4>",                    MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_SUBSTITUTION_EXPRESSION              }, { 1 },            -1,                        -1, -1 },
  { G1_META_SYMBOL,                           "<rule symbol>",                             MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_SYMBOL_NAME                          }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_SYMBOL_NAME,                      "<rule symbol name 1>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_BARE_NAME                            }, { 1 },            -1,                        -1, -1 },
  { G1_META_SYMBOL_NAME,                      "<rule symbol name 2>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_BRACKETED_NAME                       }, { 1 },            -1,                        -1, -1 },
  { G1_META_ACTION_NAME,                      "<rule action name 1>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_PERL_NAME                            }, { 1 },            -1,                        -1, -1 },
  { G1_META_ACTION_NAME,                      "<rule action name 2>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_RESERVED_ACTION_NAME                 }, { 1 },            -1,                        -1, -1 },
  { G1_META_ACTION_NAME,                      "<rule action name 3>",                      MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_ARRAY_DESCRIPTOR                     }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_QUANTIFIER,                       "<rule quantifier 1>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_STAR                             }, { 1 },            -1,                        -1, -1 },
  { G1_META_QUANTIFIER,                       "<rule quantifier 2>",                       MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL_PLUS                             }, { 1 },            -1,                        -1, -1 },
  { G1_META_DISCARD,                          "<rule discard 1>",                          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_WHITESPACE                           }, { 1 },            -1,                        -1, -1 },
  { G1_META_DISCARD,                          "<rule discard 2>",                          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_PERL_COMMENT                         }, { 1 },            -1,                        -1, -1 },
  { G1_META_DISCARD,                          "<rule discard 3>",                          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_CPLUSPLUS_COMMENT                    }, { 1 },            -1,                        -1, -1 },
  /*
    lhsi                                      descs                                        type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori propertb
  */
  { G1_META_DISCARD,                          "<rule discard 4>",                          MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_C_COMMENT                            }, { 1 },            -1,                        -1, -1 }
};
