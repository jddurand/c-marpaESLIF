...
bootstrap_grammar_meta_t bootstrap_grammar_G1_metas[] = {
  ...
  { G1_META_SEPARATOR_ASSOCIATION,            "separator association", 0, 0 },
  { G1_META_PROPER_ASSOCIATION,               "proper association", 0, 0 },
...
bootstrap_grammar_rule_t bootstrap_grammar_G1_rules[] = {
  ...
  */
  { G1_META_DISCARD_DEFAULT_STATEMENT,        G1_RULE_DISCARD_DEFAULT_STATEMENT_1,            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 4, { G1_TERMINAL_DISCARD,
                                                                                                                                     G1_TERMINAL_DEFAULT,
                                                                                                                                     G1_TERMINAL_EQUAL,
                                                                                                                                     G1_META_ADVERB_LIST                          }, -1,                        -1, -1 , G1_ACTION_DISCARD_DEFAULT_STATEMENT_1 },
  { G1_META_DISCARD_DEFAULT_STATEMENT,        G1_RULE_DISCARD_DEFAULT_STATEMENT_2,            MARPAESLIF_RULE_TYPE_ALTERNATIVE, 4, { G1_TERMINAL_DISCARD,
                                                                                                                                     G1_META_OP_DECLARE,
                                                                                                                                     G1_TERMINAL_EQUAL,
                                                                                                                                     G1_META_ADVERB_LIST                          }, -1,                        -1, -1 , G1_ACTION_DISCARD_DEFAULT_STATEMENT_2 },
  ...
  */
  ...
  { G1_META_ADVERB_ITEM,                      G1_RULE_ADVERB_ITEM_06,                         MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_SEPARATOR_ASSOCIATION                }, -1,                        -1, -1 , G1_ACTION_ADVERB_ITEM_06 },
  /*
    lhsi                                      descs                                           type                          nrhsl  { rhsi }                                       }  minimumi           separatori  properb
  */
  { G1_META_ADVERB_ITEM,                      G1_RULE_ADVERB_ITEM_07,                         MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_PROPER_ASSOCIATION                   }, -1,                        -1, -1 , G1_ACTION_ADVERB_ITEM_07 },
  ...
  */
  ...
  { G1_META_SEPARATOR_ASSOCIATION,            G1_RULE_SEPARATOR_ASSOCIATION,                  MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { G1_TERMINAL_SEPARATOR,
                                                                                                                                     G1_TERMINAL_THEN,
                                                                                                                                     G1_META_SINGLE_SYMBOL                        }, -1,                        -1, -1 , G1_ACTION_SEPARATOR_ASSOCIATION },
  /*
    lhsi                                      descs                                           type                          nrhsl  { rhsi }                                       }  minimumi           separatori  properb
  */
  { G1_META_PROPER_ASSOCIATION,               G1_RULE_PROPER_ASSOCIATION,                     MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { G1_TERMINAL_PROPER,
                                                                                                                                     G1_TERMINAL_THEN,
                                                                                                                                     G1_META_BOOLEAN                              }, -1,                        -1, -1 , G1_ACTION_PROPER_ASSOCIATION },
