...
bootstrap_grammar_rule_t bootstrap_grammar_G1_rules[] = {
  ...
  */
  ...
  { G1_META_ADVERB_ITEM,                      "<G1 rule adverb item 13>",                     MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_NAMING                               }, { 0 },            -1,                        -1, -1 },
  { G1_META_ADVERB_ITEM,                      "<G1 rule adverb item 14>",                     MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_META_NULL_ADVERB                          }, { 0 },            -1,                        -1, -1 },
  ...
  */
  ...
  /*
    lhsi                                      descs                                           type                          nrhsl  { rhsi }                                       }  { mask }    minimumi                 separatori properb
  */
  { G1_META_LATM_SPECIFICATION,               "<G1 rule latm specification 2>",               MARPAESLIF_RULE_TYPE_ALTERNATIVE, 3, { G1_TERMINAL_LATM,
                                                                                                                                     G1_TERMINAL_THEN,
                                                                                                                                     G1_META_TRUE                                 }, { 1, 1, 0},       -1,                        -1, -1 },
