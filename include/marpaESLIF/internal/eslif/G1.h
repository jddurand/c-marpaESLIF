...
bootstrap_grammar_terminal_t bootstrap_grammar_G1_terminals[] = {
  ...
  { G1_TERMINAL___INT, MARPAESLIF_TERMINAL_TYPE_STRING, NULL,
    "'::int'",
#ifndef MARPAESLIF_NTRACE
    "::int", "::in"
#else
...
bootstrap_grammar_rule_t bootstrap_grammar_G1_rules[] = {
  ...
  */
  ...
  { G1_META_ACTION_NAME,                      G1_RULE_ACTION_NAME_11,                         MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL___INT                            }, -1,                        -1,      -1,              0, G1_ACTION_ACTION_NAME_11 },
  ...
  { G1_META_SYMBOLACTION_NAME,                G1_RULE_SYMBOLACTION_NAME_10,                   MARPAESLIF_RULE_TYPE_ALTERNATIVE, 1, { G1_TERMINAL___INT                            }, -1,                        -1,      -1,              0, G1_ACTION_SYMBOLACTION_NAME_10 },
  /*
    lhsi                                      descs                                           type                          nrhsl  { rhsi }                                       }  minimumi           separatori  properb hideseparatorb  actions
  */
