...
TCONV_NO_EXPORT void  *tconv_convert_iconv_new(genericLogger_t *genericLoggerp, const char *tocodes, const char *fromcodes, void *optionp);
...
TCONV_NO_EXPORT int    tconv_convert_iconv_free(void *contextp);
