...
The transformer callbacks are called only during valuation, and always have a valid C<marpaESLIFValuep>, even if called via C<marpaESLIFGrammar_parseb()> method: in the later case, an internal C<marpaESLIFValuep> is generated.
