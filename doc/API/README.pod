...
The C<marpaESLIFRecognizer> destructor, with parameter C<marpaESLIFRecognizerp> being an instance previously created. No-op if C<marpaESLIFRecognizerp> is NULL.
