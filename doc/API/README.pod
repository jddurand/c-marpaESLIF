...
=head3 C<marpaESLIF_isinfb>

  short marpaESLIF_isinfb(marpaESLIFValueResult_t *marpaESLIFValueResultp, short *isinfbp);

Returns a true value if floating point number inside C<marpaESLIFValueResultp> is the positive or negative I<Infinity> special value.

=head3 C<marpaESLIF_isnanb>

  short marpaESLIF_isinfb(marpaESLIFValueResult_t *marpaESLIFValueResultp, short *isinfbp);

Returns a true value if floating point number inside C<marpaESLIFValueResultp> is the NaN (I<Not-A-Number>) special value.
