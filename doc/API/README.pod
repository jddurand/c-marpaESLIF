...
pop from its stack C<marpaESLIFValueResultp->u.r.sizel> elements when it receives a C<MARPAESLIF_VALUE_TYPE_ROW> callback, transforming them to what is an array for the host language

=item

pop from its stack C<marpaESLIFValueResultp->u.t.sizel * 2> elements when it receives a C<MARPAESLIF_VALUE_TYPE_TABLE> callback, transforming them to what is a hash for the host language
...
Context dependant, can be a lua specific value, injected by hand during recognizer phase for example, falling back to a LUA_TUSERDATA

=item [2]

Encoding information is attached to internal string. Since strings in Lua are unique, one string can have only one encoding.

=item [3]

A special niled table that indexed by number

=item [4]

A special niled table indexed by strings

=item [5]

java.lang.Byte or java.lang.Short or java.lang.Integer or java.lang.Long or java.math.BigInteger, depends on C<CHAR_BIT>

=item [6]

java.lang.Float (includes +/-Inf and Nan) or java.lang.Double or java.math.BigDecimal, depends on the C native data size

=item [7]

java.lang.Float or java.lang.Double or java.math.BigDecimal, depends on the C native data size

=item [8]

java.lang.Float or java.lang.Double or java.math.BigDecimal

=item [9]

java.lang.Object, if a lua specific value, injected by hand during recognizer phase for example, falling back to java.lang.Long
...
java.lang.Byte or java.lang.Short or java.lang.Integer or java.lang.Long or java.math.BigInteger
...
SV*, if be a perl specific value, injected by hand during recognizer phase for example, falling back PTR2IV()

=item [14]

$MarpaX::ESLIF::true or $MarpaX::ESLIF::false

=item [15]

PV* or MarpaX::ESLIF::String instance
