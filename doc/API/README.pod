...
=head3 marpaESLIFGrammar_symboldisplayform_currentb
...
=head3 marpaESLIFGrammar_symboldisplayform_by_levelb
...
=head3 marpaESLIFGrammar_ruleshowform_currentb
...
=head3 marpaESLIFGrammar_ruleshowform_by_levelb
...
=head3 marpaESLIFGrammar_grammarshowform_currentb

  short marpaESLIFGrammar_grammarshowform_currentb(marpaESLIFGrammar_t  *marpaESLIFGrammarp,
                                                int                   grammari,
                                                char                **grammarshowsp);

Put in the value pointed by C<grammarshowsp>, which can be C<NULL>, a NUL-terminated I<ASCII encoded> transliteration of grammar definition at indice C<grammari> of the current grammar from C<marpaESLIFGrammarp>. This is very exhaustive, and give internal information about all symbols and rules.

Return a true value on failure, a false value on failure.

=head3 marpaESLIFGrammar_grammarshowform_by_levelb
...
This is very exhaustive, and give internal information about all symbols and rules.
