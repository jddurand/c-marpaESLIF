...
A dedicated section on I<stack manipulation> is also described.
...
The type of the value. This is the enum C<marpaESLIFStackType_t> that can have these values:

=over

=item MARPAESLIF_STACK_TYPE_UNDEF

Value is undefined. This is a valid type by itself and user is allowed to push an undefined value in the stack.

=item MARPAESLIF_STACK_TYPE_CHAR

Value is a C<C>'s C<char>.

=item MARPAESLIF_STACK_TYPE_SHORT

Value is a C<C>'s C<short>.

=item MARPAESLIF_STACK_TYPE_INT

Value is a C<C>'s C<int>.

=item MARPAESLIF_STACK_TYPE_LONG

Value is a C<C>'s C<long>.

=item MARPAESLIF_STACK_TYPE_FLOAT

Value is a C<C>'s C<float>.

=item MARPAESLIF_STACK_TYPE_DOUBLE

Value is a C<C>'s C<double>.

=item MARPAESLIF_STACK_TYPE_PTR

Value is a C<C>'s C<void *> pointer.

=item MARPAESLIF_STACK_TYPE_PTR_SHALLOW

Value is a C<C>'s C<void *> shallow pointer.

=item MARPAESLIF_STACK_TYPE_ARRAY

Value is a tuple of C<C>'s C<void *> and C<C>'s C<size_t> size.

=item MARPAESLIF_STACK_TYPE_ARRAY_SHALLOW
...
Contains the C<C>'s C<char> value when type is C<MARPAESLIF_STACK_TYPE_CHAR>.

=item u.b

Contains the C<C>'s C<short> value when type is C<MARPAESLIF_STACK_TYPE_SHORT>.

=item u.i

Contains the C<C>'s C<int> value when type is C<MARPAESLIF_STACK_TYPE_INT>.

=item u.l

Contains the C<C>'s C<long> value when type is C<MARPAESLIF_STACK_TYPE_LONG>.

=item u.f

Contains the C<C>'s C<float> value when type is C<MARPAESLIF_STACK_TYPE_FLOAT>.

=item u.d

Contains the C<C>'s C<double> value when type is C<MARPAESLIF_STACK_TYPE_DOUBLE>.

=item u.p

Contains the C<C>'s C<void *> value when type is C<MARPAESLIF_STACK_TYPE_PTR>, C<MARPAESLIF_STACK_TYPE_PTR_SHALLOW>, C<MARPAESLIF_STACK_TYPE_ARRAY> or C<MARPAESLIF_STACK_TYPE_ARRAY_SHALLOW>.
...
Contains the size of the memory pointed by C<u.p> when type is C<MARPAESLIF_STACK_TYPE_PTR>, C<MARPAESLIF_STACK_TYPE_PTR_SHALLOW>, C<MARPAESLIF_STACK_TYPE_ARRAY> or C<MARPAESLIF_STACK_TYPE_ARRAY_SHALLOW>.
...
In the valuation callbacks, stack is manipulated using the functions described below. With no exception, they all return a true value on success, a false value on failure.
...
=head3 C<marpaESLIFValue_stack_is_charb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *charbp);
...
=head3 C<marpaESLIFValue_stack_is_shortb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *shortbp);
...
=head3 C<marpaESLIFValue_stack_is_intb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *intbp);
...
=head3 C<marpaESLIFValue_stack_is_longb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *longbp);
...
=head3 C<marpaESLIFValue_stack_is_floatb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *floatbp);
...
=head3 C<marpaESLIFValue_stack_is_doubleb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *doublebp);
...
=head3 C<marpaESLIFValue_stack_is_ptrb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *ptrbp);
...
=head3 C<marpaESLIFValue_stack_is_arrayb>
  ...
  short marpaESLIFValue_stack_is_undefb(marpaESLIFValue_t *marpaESLIFValuep, int indicei, short *arraybp);
