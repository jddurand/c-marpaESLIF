...
Calling C<marpaESLIFRecognizer_resumeb> is legal for any recognizer that already called <marpaESLIFRecognizer_scanb> or did at least one call to C<marpaESLIFRecognizer_lexeme_alternativeb>.
