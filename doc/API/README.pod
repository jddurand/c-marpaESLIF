...
Returns true if C<f> is an infinite number. Relies on the existence of C<isinf> of C<INFINITY> of the underlying C library.

=head3 C<marpaESLIF_isnan>

  short marpaESLIF_isnan(float f);

Returns true if C<f> is an Not-A-Number.
