...
Any application must start by instanciating a main ESLIF. This method is returning such a main C<marpaESLIF> object, with C<marpaESLIFOptionp> being an eventual pointer to a C<marpaESLIFOption_t> structure. This structure contain:
