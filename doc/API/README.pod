...
A short form of parsing and valuation, in which any I<grammar event>, which normally puts the scanning on hold, is disabled. Please refer to the L<marpaESLIF_BNF|https://github.com/jddurand/c-marpaESLIF/tree/master/doc/BNF> for more information about grammar events. The grammar at level C<0> is used.
