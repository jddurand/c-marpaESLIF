...
A recognizer is allowed to perform a match try on any symbol that is a terminal, including those that are not part of the current grammar:
  ...
  /* When there is match marpaESLIFValueResultArrayp, if set, will contain the result */
  /* The end-user is responsible to free it when marpaESLIFValueResultArrayp->shallowb is false. */
  short                        marpaESLIFSymbol_tryb(marpaESLIFSymbol_t *marpaESLIFSymbolp,
                                                     char *inputs,
                                                     size_t inputl,
                                                     short *matchbp,
                                                     marpaESLIFValueResultArray_t *marpaESLIFValueResultArrayp);
