...
You see that we have implemented an importer: this is a B<required> callback as soon as a user of the marpaESLIF API is doing valuation: the importer is always invoked at the very end of the parsing to transfer result to userland.
