...
marpaESLIF BNF can be expressed in itself:
  ...
  <rhs primary>                  ::= <single symbol>
                                   ...
                                   | <rhs primary> <arguments declaration>
  ...
  <parameters>                   ::= <parameter>* separator => ',' proper => 1 hide-separator => 1
  <parameter>                    ::= /[a-zA-Z_][a-zA-Z0-9_]*/
  <arguments declaration>        ::= '->(' <arguments> ')'
  <arguments>                    ::= <argument>* separator => ',' proper => 1 hide-separator => 1
  <argument>                     ::= '$' /[a-zA-Z_][a-zA-Z0-9_]*/
  <argument>                     ::= <rhs primary>
