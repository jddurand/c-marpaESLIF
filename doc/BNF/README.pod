...
A rule consist of a left symbol, followed by C<< => >> or the Rightwards Double Arrow UTF-8 character C<⇒>, followed by one or more symbols, or a single quantified symbol:
