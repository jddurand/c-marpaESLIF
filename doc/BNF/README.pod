...
Internally this correspond to this set of options in PCRE2:
  ...
  ---------------------------------------------------------------------------------------------------------------
  Modifiers         PCRE2 match flag unset   PCRE2 match flag set                       PCRE2 substitute flag set
  ---------------------------------------------------------------------------------------------------------------
  e                                          PCRE2_MATCH_UNSET_BACKREF                  PCRE2_SUBSTITUTE_UNSET_EMPTY
  E                                                                                     PCRE2_SUBSTITUTE_UNSET_EMPTY|PCRE2_SUBSTITUTE_UNKNOWN_UNSET
  ...
  n                                          PCRE2_UCP
  s                                          PCRE2_DOTALL
  x                                          PCRE2_EXTENDED                             PCRE2_SUBSTITUTE_EXTENDED
