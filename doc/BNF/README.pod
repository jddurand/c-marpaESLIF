...
which is stricyl equivalent, in traditional BNF syntax to:
...
Therefore the I<loosen> operator C<||> is a I<convenience> operator, it is always possible to write an equivalent grammar without it, though this can become quite tedious.
