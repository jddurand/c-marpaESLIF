MACRO (MYPACKAGELIBRARY config_in config_out)
  ...
  FOREACH (_target ${PROJECT_NAME} ${PROJECT_NAME}_static)
    ...
    ENDFOREACH ()
  ENDFOREACH ()
  INSTALL (TARGETS ${PROJECT_NAME}        RUNTIME DESTINATION bin LIBRARY DESTINATION lib ARCHIVE DESTINATION lib COMPONENT DynamicLibraryComponent)
  INSTALL (TARGETS ${PROJECT_NAME}_static RUNTIME DESTINATION bin LIBRARY DESTINATION lib ARCHIVE DESTINATION lib COMPONENT StaticLibraryComponent)
