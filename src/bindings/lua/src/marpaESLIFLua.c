...
/*****************************************************************************/
{
  ...
  sizei = (lua_Integer) marpaESLIFLuaXstringContextp->sizel;

  if (! marpaESLIFLua_xstring_check_from_and_tob(L, sizei, &fromi, &toi)) goto err;
...
/*****************************************************************************/
{
  ...
  if (! marpaESLIFLua_luaL_checkinteger(&fromi, L, 2)) goto err;
  if (fromi < 0) {
