...
static inline short                       marpaESLIFLua_stack_setb(lua_State *L, int stringtoencoding_r, int opaque_r, marpaESLIF_t *marpaESLIFp, genericStack_t *marpaESLIFValueResultStackp, marpaESLIFValue_t *marpaESLIFValuep, int resulti, marpaESLIFValueResult_t *marpaESLIFValueResultOutputp);
...
#define MARPAESLIFLUA_DEREF(L, refi) do {                               \
    ...
    if (! marpaESLIFLua_lua_rawgeti(1 /* checkstackb */, NULL, L, -1, refi)) goto err;                                            /* Stack: ..., MARPAESLIFLUAREGISTRYINDEX, MARPAESLIFLUAREGISTRYINDEX[refi] */ \
...
#define MARPAESLIFLUA_DEREF(L, refi) do {                               \
    if (! marpaESLIFLua_lua_rawgeti(1 /* checkstackb */, NULL, L, LUA_REGISTRYINDEX, refi)) goto err; \
  } while (0);
...
#define MARPAESLIFLUA_STRING_ENCODINGS(L, marpaESLIFp, bytep, bytel, ep) do { \
    ...
    if ((bytep == NULL) || (bytel <= 0)) {                              \
      ...
      if (! marpaESLIFLua_lua_gettable(1 /* checkstackb */, NULL, L, -2)) goto err;                                                  /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE, encoding */ \
...
#define MARPAESLIFLUA_PUSH_CANARRAY_AWARE_TABLE(L, narr, nrec, canarrayb) do { \
    if (! marpaESLIFLua_lua_createtable(1 /* checkstackb */, L, narr, nrec)) goto err;                  /* Stack: ..., {} */ \
    if (! marpaESLIFLua_lua_createtable(1 /* checkstackb */, L, 0 /* narr */, 1 /* nrec */)) goto err;  /* Stack: ..., {}, {} */ \
...
/****************************************************************************/
{
  ...
  case 1:
    ...
    if (! marpaESLIFLua_lua_gettable(1 /* checkstackb */, NULL, L, -2)) goto err;                                             /* Stack: MARPAESLIFSTRINGTOENCODINGTABLE, encodings */
...
/****************************************************************************/
{
  ...
  marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp = NULL;
  ...
  marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp = &(marpaESLIFLuaGrammarContextp->_marpaESLIFValueResultStack);
  GENERICSTACK_INIT(marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp);
  if (GENERICSTACK_ERROR(marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp)) {
    marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp = NULL;
...
/****************************************************************************/
{
  ...
  marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp = NULL;
  ...
  marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp = &(marpaESLIFLuaRecognizerContextp->_marpaESLIFValueResultStack);
  GENERICSTACK_INIT(marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp);
  if (GENERICSTACK_ERROR(marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp)) {
    marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp = NULL;
    marpaESLIFLua_luaL_errorf(L, "marpaESLIFValueResultStackp initialization failure, %s", strerror(errno));
    goto err;
  }
...
/****************************************************************************/
{
  ...
  if (marpaESLIFLuaGrammarContextp != NULL) {
    ...
    if (marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp != NULL) {
      GENERICSTACK_RESET(marpaESLIFLuaGrammarContextp->marpaESLIFValueResultStackp);
    }
...
/****************************************************************************/
{
  ...
  if (marpaESLIFLuaRecognizerContextp != NULL) {
    ...
    if (marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp != NULL) {
      GENERICSTACK_RESET(marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp);
    }
...
/****************************************************************************/
{
  ...
  if (marpaESLIFLuaValueContextp != NULL) {
    ...
    if (marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp != NULL) {
      GENERICSTACK_RESET(marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp);
    }
...
/****************************************************************************/
{
  ...
  marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp = NULL;
  ...
  marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp = &(marpaESLIFLuaValueContextp->_marpaESLIFValueResultStack);
  GENERICSTACK_INIT(marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp);
  if (GENERICSTACK_ERROR(marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp)) {
    marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp = NULL;
    marpaESLIFLua_luaL_errorf(L, "marpaESLIFValueResultStackp initialization failure, %s", strerror(errno));
    goto err;
  }
...
/*****************************************************************************/
{
  ...
  if (! marpaESLIFLua_stack_setb(L, marpaESLIFLuaValueContextp->stringtoencoding_r, marpaESLIFLuaValueContextp->opaque_r, marpaESLIFLuaValueContextp->marpaESLIFp, marpaESLIFLuaValueContextp->marpaESLIFValueResultStackp, marpaESLIFValuep, resulti, NULL /* marpaESLIFValueResultOutputp */)) goto err;
...
/*****************************************************************************/
{
  ...
  case MARPAESLIF_VALUE_TYPE_PTR:
    ...
    if (marpaESLIFValueResultp->contextp == MARPAESLIFLUA_CONTEXT) {
      ...
      *marpaESLIFValueResultDupp = *marpaESLIFValueResultp;
      if (! marpaESLIFLua_lua_pushlightuserdata(1 /* checkstackb */, L, marpaESLIFValueResultDupp->u.p.p)) goto err;
      ...
      MARPAESLIFLUA_DEREF(L, opaque_r);                                                                                          /* Stack: ..., marpaESLIFValueResultp->u.p.p, MARPAESLIFOPAQUETABLE */
      if (! marpaESLIFLua_lua_pushlightuserdata(1 /* checkstackb */, L, marpaESLIFValueResultDupp->u.p.p)) goto err;                                  /* Stack: ..., marpaESLIFValueResultp->u.p.p, MARPAESLIFOPAQUETABLE, marpaESLIFValueResultp->u.p.p */
      if (! marpaESLIFLua_lua_pushlightuserdata(1 /* checkstackb */, L, marpaESLIFValueResultDupp)) goto err;                                         /* Stack: ..., marpaESLIFValueResultp->u.p.p, MARPAESLIFOPAQUETABLE, marpaESLIFValueResultp->u.p.p, marpaESLIFValueResultDupp */
  ...
  case MARPAESLIF_VALUE_TYPE_STRING:
    ...
    /* Note that the key is weak, i.e. we do not maintain a reference to the string */
    MARPAESLIFLUA_DEREF(L, stringtoencoding_r);                                                                                                                     /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE */
    if ((marpaESLIFValueResultp->u.s.p != NULL) && (marpaESLIFValueResultp->u.s.sizel > 0)) {
      if (! marpaESLIFLua_lua_pushlstring(1 /* checkstackb */, NULL, L, (const char *) marpaESLIFValueResultp->u.s.p, marpaESLIFValueResultp->u.s.sizel)) goto err; /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE, string */
    } else {
      if (! marpaESLIFLua_lua_pushlstring(1 /* checkstackb */, NULL, L, "", 0)) goto err;                                                                           /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE, "" */
    }
    if (! marpaESLIFLua_lua_pushstring(1 /* checkstackb */, NULL, L, marpaESLIFValueResultp->u.s.encodingasciis)) goto err;                                         /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE, string, encodingasciis */
    if (! marpaESLIFLua_lua_settable(L, -3)) goto err;                                                                                                              /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE */
    if (! marpaESLIFLua_lua_pop(L, 1)) goto err;                                                                                                                    /* Stack: ... */
...
/*****************************************************************************/
{
  ...
  if (! marpaESLIFLua_lua_type(&typei, L, 1)) goto err;
    ...
    if (! marpaESLIFLua_stack_setb(L, marpaESLIFLuaRecognizerContextp->stringtoencoding_r, marpaESLIFLuaRecognizerContextp->opaque_r, marpaESLIFLuaRecognizerContextp->marpaESLIFp, marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp, NULL /* marpaESLIFValuep */, -1 /* resulti */, &(marpaESLIFAlternative.value))) goto err;
    break;
  default:
...
/****************************************************************************/
{
  ...
  if (! marpaESLIFLua_lua_newtable(1 /* checkstackb */, L)) goto err;                           /* Stack: xxx, visitedTable */
  if (! marpaESLIFLua_lua_insert(1 /* checkstackb */, L, -2)) goto err;                         /* Stack: visitedTable, xxx */
...
#  endif /* defined(LUA_FLOAT_FLOAT) && (LUA_FLOAT_FLOAT == LUA_FLOAT_TYPE) */
    ...
    case LUA_TSTRING:
      ...
      /* Note that the key is weak, i.e. we do not maintain a reference to the string */
      MARPAESLIFLUA_DEREF(L, stringtoencoding_r);                                                          /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE */
      if (! marpaESLIFLua_lua_pushnil(1 /* checkstackb */, L)) goto err;                                   /* Stack: ..., MARPAESLIFSTRINGTOENCODINGTABLE, nil */
      ...
      if (! opaqueb) {
        ...
        while (1) {
          ...
          if (keyTypei == LUA_TTABLE) {
            ...
            if (! marpaESLIFLua_lua_gettable(1 /* checkstackb */, NULL, L, visitedTableIndicei)) goto err; /* Stack: visitedTable, ..., xxx=table, key, value, visitableTable[key] */
            isnili = 0;
            if (! marpaESLIFLua_lua_isnil(&isnili, L, -1)) goto err;
            if (! isnili) {
            ...
            if (! marpaESLIFLua_lua_pushnil(1 /* checkstackb */, L)) goto err;                          /* Stack: visitedTable, ..., xxx=table, key, value, nil */
            if (! marpaESLIFLua_lua_copy(L, -3, -1)) goto err;                                          /* Stack: visitedTable, ..., xxx=table, key, value, key */
            if (! marpaESLIFLua_lua_pushboolean(1 /* checkstackb */, L, 1)) goto err;                   /* Stack: visitedTable, ..., xxx=table, key, value, key, true */
          ...
          if (valueTypei == LUA_TTABLE) {
            ...
            if (! marpaESLIFLua_lua_gettable(1 /* checkstackb */, NULL, L, visitedTableIndicei)) goto err; /* Stack: visitedTable, ..., xxx=table, key, value, visitableTable[value] */
            isnili = 0;
            if (! marpaESLIFLua_lua_isnil(&isnili, L, -1)) goto err;
            if (! isnili) {
              if (! marpaESLIFLua_lua_pop(L, 3)) goto err;                                              /* Stack: visitedTable, ..., xxx=table */
            ...
            if (! marpaESLIFLua_lua_pushnil(1 /* checkstackb */, L)) goto err;                          /* Stack: visitedTable, ..., xxx=table, key, value, nil */
            if (! marpaESLIFLua_lua_copy(L, -2, -1)) goto err;                                          /* Stack: visitedTable, ..., xxx=table, key, value, value */
            if (! marpaESLIFLua_lua_pushboolean(1 /* checkstackb */, L, 1)) goto err;                   /* Stack: visitedTable, ..., xxx=table, key, value, value, true */
	    ...
	    marpaESLIFValueResultp->u.r.freeCallbackp  = marpaESLIFLua_genericFreeCallbackv;
            ...
            for (i = 0, arrayl = 1; i < tablel; i++, arrayl++) {
              if (! marpaESLIFLua_lua_pushinteger(1 /* checkstackb */, L, (lua_Integer) arrayl)) goto err; /* Stack: visitedTable, ..., xxx=table, i */
              if (! marpaESLIFLua_lua_gettable(1 /* checkstackb */, NULL, L, currenti)) goto err;          /* Stack: visitedTable, ..., xxx=table, table[i] */
	    ...
	    marpaESLIFValueResultp->u.t.freeCallbackp  = marpaESLIFLua_genericFreeCallbackv;
            if (tablel > 0) {
              ...
              while (1) {
                ...
                if (! marpaESLIFLua_lua_pushnil(1 /* checkstackb */, L)) goto err;                        /* Stack: visitedTable, ..., xxx=table, key, value, key, nil */
    ...
    case LUA_TLIGHTUSERDATA:
      ...
      MARPAESLIFLUA_DEREF(L, opaque_r);                                                                                          /* Stack: ..., MARPAESLIFOPAQUETABLE */
...
/****************************************************************************/
{
  ...
  if (isnili) {                                                                                     /* Stack: ..., nil */
    ...
    *iteratorip = iteratori;
    ...
    MARPAESLIFLUA_DEREF(L, *iteratorip);                                                            /* Stack: ..., [+1] key,         [+2] iterator */
    if (! marpaESLIFLua_lua_insert(0 /* checkstackb */, L, -2)) goto err;                           /* Stack: ..., [+1] iterator,    [+2] key */
    MARPAESLIFLUA_DEREF(L, *statevariableip);                                                       /* Stack: ..., [+1] iterator,    [+2] key,           [+3] statevariable */
...
/****************************************************************************/
{
  ...
  /* We convert value at indice -1 to a marpaESLIFValueResult */
  if (! marpaESLIFLua_stack_setb(L, marpaESLIFLuaJSONEncoderContextp->stringtoencoding_r, marpaESLIFLuaJSONEncoderContextp->opaque_r, marpaESLIFLuaJSONEncoderContextp->marpaESLIFp, marpaESLIFLuaJSONEncoderContextp->marpaESLIFValueResultStackp, NULL /* marpaESLIFValuep */, -1 /* resulti */, &marpaESLIFValueResult)) goto err;
  if (! marpaESLIFLua_lua_pop(L, 2)) goto err;                                             /* Stack: */
...
/****************************************************************************/
{
  ...
  if (! marpaESLIFLua_stack_setb(L, marpaESLIFLuaJSONDecoderContextp->stringtoencoding_r, marpaESLIFLuaJSONDecoderContextp->opaque_r, marpaESLIFLuaJSONDecoderContextp->marpaESLIFp, marpaESLIFLuaJSONDecoderContextp->marpaESLIFValueResultStackp, NULL /* marpaESLIFValuep */, -1 /* resulti */, &marpaESLIFValueResult)) goto err;
...
/*****************************************************************************/
{
  ...
  if (! marpaESLIFLua_stack_setb(L, marpaESLIFLuaRecognizerContextp->stringtoencoding_r, marpaESLIFLuaRecognizerContextp->opaque_r, marpaESLIFLuaRecognizerContextp->marpaESLIFp, marpaESLIFLuaRecognizerContextp->marpaESLIFValueResultStackp, NULL /* marpaESLIFValuep */, -1 /* resulti */, contextp)) goto err;
