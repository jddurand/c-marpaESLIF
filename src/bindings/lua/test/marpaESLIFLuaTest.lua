...
recognizerInterface = {
   ...
   ["do_regex"]             = function(self, block)
      ...
      logger:tracef('lua_regexaction: calloutNumber          = %s, type %s', tostring(block:getCalloutNumber()), type(block:getCalloutNumber()))
      logger:tracef('lua_regexaction: calloutString          = %s, type %s', tostring(block:getCalloutString()), type(block:getCalloutString()))
      logger:tracef('lua_regexaction: subject                = %s, type %s', tostring(block:getSubject()), type(block:getSubject()))
      logger:tracef('lua_regexaction: pattern                = %s, type %s', tostring(block:getPattern()), type(block:getPattern()))
      logger:tracef('lua_regexaction: captureTop             = %s, type %s', tostring(block:getCaptureTop()), type(block:getCaptureTop()))
      logger:tracef('lua_regexaction: captureLast            = %s, type %s', tostring(block:getCaptureLast()), type(block:getCaptureLast()))
      logger:tracef('lua_regexaction: offsetVector           = %s', tableDump(block:getOffsetVector()))
      logger:tracef('lua_regexaction: mark                   = %s, type %s', tostring(block:getMark()), type(block:getMark()))
      logger:tracef('lua_regexaction: currentPosition        = %s, type %s', tostring(block:getCurrentPosition()), type(block:getCurrentPosition()))
      logger:tracef('lua_regexaction: nextItem               = %s, type %s', tostring(block:getNextItem()), type(block:getNextItem()))
      logger:tracef('lua_regexaction: grammarLevel           = %s, type %s', tostring(block:getGrammarLevel()), type(block:getGrammarLevel()))
      logger:tracef('lua_regexaction: symbolId               = %s, type %s', tostring(block:getSymbolId()), type(block:getSymbolId()))
      logger:tracef('lua_regexaction: recognizer             = %s, type %s', tostring(self:getRecognizer()), type(self:getRecognizer()))
      logger:tracef('lua_regexaction: recognizer.input(0, 3) = %s, type %s', tostring(self:getRecognizer():input(0, 3)), type(self:getRecognizer():input(0, 3)))
      return 0
   end,
