...
static char                           *marpaESLIF_sv2byte(pTHX_ SV *sv, char **bytepp, size_t *bytelp, short *characterStreambp, char **encodingOfEncodingsp, char **encodingsp, size_t *encodinglp, short warnIsFatalb);
