...
which will return a perl's string for the last paused inforéation for lexeme C<symbolName>, or C<undef> if there is none. The number of C<bytes> in this string is the relevant thing here.
