...
static void marpaESLIFValueContextFree(JNIEnv *envp, valueInterfaceContext_t *valueInterfaceContextp, short onStackb);
...
/*****************************************************************************/
{
 ...
 err:
  ...
  marpaESLIFValueContextFree(envp, &valueInterfaceContext, 1 /* onStackb */);
