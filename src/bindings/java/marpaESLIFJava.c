...
/*****************************************************************************/
{
  ...
  if (! rcb) {
    RAISEEXCEPTIONF(envp, "%s rule action callback failure", valueInterfaceContextp->actions);
  }
...
/*****************************************************************************/
{
  ...
  if (! rcb) {
    RAISEEXCEPTIONF(envp, "%s symbol action callback failure", valueInterfaceContextp->actions);
  }
