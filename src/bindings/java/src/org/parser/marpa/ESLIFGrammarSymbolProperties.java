...
public class ESLIFGrammarSymbolProperties {
	 ...
	 * @param propertyBitSet low-level grammar properties
	...
	public int hashCode() {
		...
		result = prime * result + eventBitSet;
	...
	/**
	 * @return the low-level events (combination of ESLIFSymbolEventBitSet values)
	 */
	public int getEventBitSet() {
		return eventBitSet;
	}

	/**
	 * @return the symbol action
	 */
