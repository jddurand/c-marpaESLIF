static const char *marpaESLIFJSON_decode_strict_grammars =
  ...
  "/* Extended grammar have this event:                 3_CNTRL_CHAR$ */\n"
  ":lexeme    ::= CONSTANT     pause => after  event => 4_CONSTANT$\n"
  ":lexeme    ::= DQUOTE_START pause => after  event => 5_DQUOTE_START$  # For string initialization + discard hook\n"
  ":lexeme    ::= DQUOTE_END   pause => after  event => 6_DQUOTE_END$    # For discard hook\n"
